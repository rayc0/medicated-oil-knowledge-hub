---
title: "Fang Feng (Saposhnikovia divaricata) Pharmacology — The Wind-Releasing Root Behind Wind-Cold Liniments, Anti-Itch Oils, and Classical Dit Da Jow"
description: "A complete pharmacological deep-dive into Fang Feng (防风 / Saposhnikovia divaricata), the chromone- and coumarin-rich root that anchors classical wind-cold liniments, anti-itch oils, and gentle dit da jow formulas — covering cimifugin, prim-O-glucosylcimifugin, 4′-O-glucosyl-5-O-methylvisamminol, NF-κB and MAPK inhibition, transdermal behavior, formulation pairings, and safety."
lang: en
...
- *Saposhnikovia divaricata* is the only botanical source recognized by the Chinese, Japanese, and Korean pharmacopoeias. So-called *Chuan Fang Feng* and *Yun Fang Feng* — sometimes from *Seseli* or *Peucedanum* species — are regional substitutes with different chromone profiles and should not be assumed equivalent.
- The medicinal part is strictly the root, harvested in spring or autumn from plants two or more years old. Younger roots are thin and chromone-poor.
...
- **prim-O-glucosylcimifugin** — typically the single most abundant chromone in the root, used as a quantitative marker by the Chinese Pharmacopoeia
- **4′-O-β-D-glucosyl-5-O-methylvisamminol** — the second pharmacopoeial marker; together with prim-O-glucosylcimifugin it must reach a minimum threshold for the root to qualify as authentic
- **cimifugin** — the aglycone (sugar-free) form, generated when the glucoside is hydrolyzed by gut flora or by alcohol extraction
- **sec-O-glucosylhamaudol** and **3′-O-acetylhamaudol** — minor but pharmacologically active
- **divaricatol, ledebouriellol, hamaudol** — further chromone backbones
...
- a high percentage of ethanol (the dit da jow case — typically 40–60% v/v),
- a glycol penetration enhancer (propylene glycol, butylene glycol), or
- a co-solvent terpene (menthol, borneol, camphor, eucalyptol) that fluidizes intercellular lipids.
...
- **Dit da jow (跌打药酒)** — both the Hong Kong and southern Chinese lineages
- **Wind-cold liniments** sold under the broad "风湿油" or "驅風油" umbrella, often alongside camphor and menthol
- **Anti-itch oils and wind-rash washes** in the Lingnan and Taiwan traditions
- **Postnatal "wind-guarding" rubs** (产后防风油) — where Fang Feng's *yu er bu zao* gentleness is critical because postpartum skin is sensitive
- **Compound headache oils** containing Bai Zhi and Chuan Xiong
...
- [HKBU School of Chinese Medicine — Medicinal Materials Image Database, 防风 entry](https://sys01.lib.hkbu.edu.hk/cmed/mmid/detail.php?pid=B00054)
- [HK Council for the Promotion of Chinese Medicine — *Saposhnikovia divaricata* DNA reference factsheet](https://www.cmro.gov.hk/files/gcmti/research/btc/dna_sequences/Factsheet_Saposhnikovia_divaricata_SC.pdf)
