---
title: "Wei Ling Xian (Clematis chinensis) Pharmacology — The 'Wind-Cutting Vine' Behind Dit Da Jow, Wind-Damp Joint Liniments, and Stiff-Neck Oils"
description: "A pharmacology-grade deep dive into Wei Ling Xian (威灵仙, Radix Clematidis) — the protoanemonin, anemonin, and oleanane saponin chemistry behind the wind-damp dispelling, channel-unblocking root that anchors classical dit da jow, joint liniments, and stiff-neck oils across Greater China and Southeast Asia."
lang: en
...
- **Flavor:** acrid (辛), salty (咸)
- **Nature:** warm (温)
- **Toxicity:** mildly toxic (小毒) — a label that matters; see safety section
- **Channels entered:** Bladder (膀胱)
- **Functions:** dispels wind-damp (祛风除湿), unblocks the channels and collaterals (通络止痛), softens and dissolves obstructions (消骨鯁)
- **Classical indications:** wind-damp painful obstruction (风湿痹痛), spasm and contracture of the limbs (肢体麻木), inhibited movement (筋脉拘挛), low back and lower-limb pain that radiates and "moves around"
...
- Traditional Hung Gar, Choy Li Fut, and Wing Chun dit da jow recipes
- Modern OTC wind-damp liniments labeled for low back pain or neck-shoulder stiffness
- Herbal patches and plasters aimed at chronic spinal pain
- Hospital-style external lotions for post-fracture rehabilitation along the spine
- Foot-bath powders for cold-damp lower-limb stiffness

Outside of dit da jow, Wei Ling Xian also appears in:

- **Stiff-neck oils** marketed at office workers and mahjong players
- **Back-pain liniments** in Hong Kong and Guangdong pharmacies
- **Hot herbal compress packs** (热敷包) used in TCM physiotherapy clinics
- **Wash decoctions** (洗剂) for chronic post-injury joint swelling
...
- **Extraction medium:** high-proof grain alcohol (45–60% ABV) is the traditional choice and pulls both the anemonin fraction and the saponin fraction efficiently. Hot water extracts a different, more polar profile and is typically used in compress packs.
- **Maceration time:** classical dit da jow recipes call for at least 30 days, often 100 days, sometimes a year or longer. Long maceration completes the protoanemonin → anemonin conversion and also gives the saponins time to extract. Insufficient aging is the single most common reason a homemade dit da jow is harsh on the skin.
- **Dose proportion in formula:** typically 6–15% of the dry-weight herb load. Wei Ling Xian is rarely the dominant herb in a formula — its job is to direct the action of the rest into the Bladder channel.
- **Compatibility:** pairs cleanly with Du Huo, Qiang Huo, Fang Feng, Tou Gu Cao, Shen Jin Cao, Mu Gua, Niu Xi, Hai Feng Teng. Non-conflicting with camphor/menthol/methyl salicylate top-notes.
- **Processing:** in some classical formulas the root is wine-stir-fried (酒炙) before maceration to enhance the channel-moving effect. Modern industrial production usually uses the unprocessed dried root.
...
- **Protoanemonin irritation:** the fresh root and any inadequately dried or aged material can contain enough residual protoanemonin to cause skin redness, burning, and in rare cases blistering. Properly dried, well-aged root extracted in alcohol over 30+ days is well tolerated. If a homemade dit da jow burns or stings on contact, it is almost always under-aged Wei Ling Xian or under-aged Cao Wu speaking.
- **Patch testing:** as with any topical liniment containing this herb, a small patch test on the inner forearm before broader use is reasonable, especially in people with sensitive skin or a history of contact dermatitis.
- **Broken skin:** do not apply over open wounds, abrasions, or recently sutured tissue. The remaining anemonin fraction is non-blistering but can still irritate compromised skin barriers.
- **Pregnancy:** classical texts contraindicate Wei Ling Xian in pregnancy due to its strong moving and channel-opening action. Avoid liniments containing it on the abdomen and lower back during pregnancy. Topical use elsewhere on the body should be discussed with a qualified TCM practitioner.
- **Children:** while topical use in older children is generally well tolerated, formulas containing Wei Ling Xian are typically not recommended for infants under one year — the standard caution for any rubefacient, channel-moving liniment.
- **Quality and species confusion:** the *Pharmacopoeia* standard accepts *C. chinensis*, *C. hexapetala*, and *C. manshurica*. In some regional markets, other Clematis species — including *C. florida*, *C. paniculata*, or *Clematis armandii* — have been substituted. The substitutes contain similar but not identical chemistry. For formulators, sourcing from a reputable supplier matters.
- **Internal vs topical:** the toxicity warnings in classical texts are primarily about *internal* overdose (mouth burning, vomiting, severe diarrhea). Topical use at properly aged formulation strengths is not associated with these effects. The cautions transferred above are the topically relevant subset.
...
- **威灵仙** (Wei Ling Xian) — the standard Chinese name
- **Radix Clematidis** or **Clematidis Radix et Rhizoma** — the pharmacopeial Latin name
- **Clematis chinensis** — the binomial (also *C. hexapetala*, *C. manshurica*)
- **Chinese clematis** or **Chinese clematis root** — common English names
- **铁脚威灵仙** (Tie Jiao Wei Ling Xian) — "iron-foot Wei Ling Xian," a market-grade designation referring to the dark, sturdy roots of *C. chinensis* specifically (as opposed to the lighter-colored *C. hexapetala*)
...
- [Dit da jow — Wikipedia](https://en.wikipedia.org/wiki/Dit_da_jow)
