---
title: "Dragon's Blood (Xue Jie) Pharmacology — The Crimson Resin in TCM Trauma Formulations"
description: "A comprehensive pharmacology guide to Dragon's Blood (Xue Jie / Sanguis Draconis), the deep-red resin used in Zheng Gu Shui, Die Da Jiu, and traumatic injury formulations. Covers botanical sources (Daemonorops draco vs Dracaena cochinchinensis), active compounds (dracorhodin, dracorubin, proanthocyanidins, taspine), wound-healing mechanisms, dosing in medicated oils, and safety."
lang: en
...
## How it appears in popular medicated oils
...
- **Acute trauma (first 24–48 hours)**: For a fresh sprain or bruise, the conservative practice is **ice first, then Xue Jie–containing liniment after the first 24 hours** when the goal shifts from limiting hemorrhage to mobilizing the resolved hematoma. Some traditional schools apply it immediately on the theory that the resin "stops bleeding while moving stasis"; the modern Western sports-medicine analogue is closer to "ice first, then move."
- **Subacute and chronic stage (3+ days)**: Apply 2–3 times daily, massaging in the direction of venous return (toward the heart) until the liniment evaporates. Cover with a dry dressing only — never seal under plastic wrap, which traps the alcohol carrier and can cause skin maceration.
- **Slow-healing skin lesions**: For minor non-infected ulcers or post-surgical wound edges, Xue Jie powder (not liquid liniment) is preferred — sprinkle a thin layer once daily after cleansing. The powder forms a protective tannin-protein film. Liquid liniments contain enough alcohol to sting open wounds and are generally avoided on broken skin.
- **Avoid on the face**: The deep red staining is hard to remove from facial skin and clothing.
...
- [Anti-inflammatory and barrier repair mechanisms of active components in *Daemonorops draco* Bl. for UVB-induced skin damage — Scientific Reports / PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC12085626/)
- [A Systematic Review of the Botanical, Phytochemical and Pharmacological Profile of *Dracaena cochinchinensis* — PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC6270834/)
- [Hypoglycemic effects of dracorhodin and dragon blood crude extract from *Daemonorops draco* — Botanical Studies](https://link.springer.com/article/10.1186/s40529-024-00415-1)
- [In vivo pro-angiogenic effects of dracorhodin perchlorate in zebrafish embryos — ScienceDirect](https://www.sciencedirect.com/science/article/pii/S1021949818301492)
- [Dragon's Blood — LiverTox, NCBI Bookshelf](https://www.ncbi.nlm.nih.gov/books/NBK604848/)
- [Xue Jie (Dragon's Blood) — TCM Herb Information, Me & Qi](https://www.meandqi.com/herb-database/dragon-s-blood)
