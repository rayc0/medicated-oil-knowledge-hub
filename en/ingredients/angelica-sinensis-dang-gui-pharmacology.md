---
title: "Angelica sinensis (Dang Gui / 当归) Pharmacology — The Blood-Moving Root Behind Dit Da Jow, Postpartum Warming Oils, and Modern Circulation Liniments"
description: "A pharmacology deep-dive on Angelica sinensis (Dang Gui, 当归): ligustilide, ferulic acid, n-butylidenephthalide, the analgesic and microcirculatory mechanisms behind its use in dit da jow, eight-treasure liniments, postpartum oils, and modern Asian medicated formulations — plus topical safety notes."
lang: en
...
1. **Which part of the root?** "Dang Gui Wei" or "Angelica sinensis radicis lateralis" implies the formulator chose the blood-moving fraction. "Dang Gui" alone usually means whole root, which is fine.
2. **What is the carrier?** Alcohol (ethanol, in dit da jow) is a far more efficient phthalide carrier than a heavy mineral-oil base. Cosmetic products that list Dang Gui near the bottom of an oil-only ingredient list are likely using it for marketing and aroma rather than meaningful active loading.
3. **What's it standing next to?** Dang Gui paired with chuan xiong, hong hua, and the resins (ru xiang/mo yao) is a classical, internally consistent trauma formula. Dang Gui alone next to mineral oil and fragrance is a scent claim.
