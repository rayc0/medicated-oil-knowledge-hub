---
title: "Bai Xian Pi (Dictamnus dasycarpus) Pharmacology — Dictamnine, Fraxinellone, and the Rutaceae Root Bark That Completes the Chinese Anti-Itch Trio"
description: "Deep dive into Bai Xian Pi (Cortex Dictamni) pharmacology — furoquinoline alkaloids (dictamnine, γ-fagarine, skimmianine), degraded limonoids (fraxinellone, obacunone), antifungal and antipruritic mechanisms, the classical pairing with Ku Shen and She Chuang Zi, and the modern hepatotoxicity and phototoxicity debate that earned this herb regulatory warnings across Europe."
lang: en
...
1. **Lipophilicity.** All members of this family are small, planar, weakly basic, and reasonably lipid-soluble. They penetrate the stratum corneum well from oily or alcoholic vehicles, which is one reason the herb is normally extracted into wine or sesame oil rather than water-only when used externally.
2. **Photoreactivity.** The furan-fused planar aromatic structure is closely related to the **furocoumarin (psoralen) family** chemically. Like psoralens, furoquinolines can absorb UVA light, form excited triplet states, and crosslink to pyrimidine bases in DNA. This is the mechanistic origin of the herb's documented **phototoxicity** — a property that overlaps with that of [She Chuang Zi](./she-chuang-zi-cnidium-monnieri-pharmacology.md) and explains why both herbs share the same "no sun after application" warning on responsibly-labelled washes.
...
- **Wind-damp arthralgia (风湿痹证)** — the herb is combined with [Du Huo](./du-huo-angelica-pubescens-pharmacology.md), [Qiang Huo](./qiang-huo-notopterygium-pharmacology.md), and [Fang Feng](./fang-feng-saposhnikovia-divaricata-pharmacology.md) for migratory joint pain with skin involvement, where the antipruritic action overlaps with the anti-inflammatory effect.
- **Jaundice from damp-heat (湿热黄疸)** — historical use, paired with [Gardenia (Zhi Zi)](./gardenia-zhi-zi-pharmacology.md) and Yin Chen Hao. Modern clinicians use this indication cautiously because of the hepatotoxicity question (next section).
- **Toxic sores and yellow-water rash (黄水疮)** — combined with [Huang Bai](./ku-shen-sophora-flavescens-pharmacology.md), [Cang Zhu], and topical zinc-based powders for impetigo-like lesions in children.
...
1. **Substitution with *Ku Lian Pi* (chinaberry bark)** — discussed above; chemically and toxicologically very different. The differentiator is smell (chinaberry lacks the goat note) and the absence of dictamnine on HPLC.
2. **Padding with cheaper Rutaceae root barks** — most often *Acanthopanax* (Wu Jia Pi, see [our deep dive](./wu-jia-pi-acanthopanax-pharmacology.md)) or *Phellodendron* bark, both of which differ in colour, layered cross-section, and alkaloid fingerprint.
