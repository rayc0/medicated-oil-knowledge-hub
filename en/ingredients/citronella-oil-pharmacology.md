---
title: "Citronella Oil Pharmacology — Citronellal, Geraniol, and the Insect-Repellent Note in Medicated Oils"
description: "Deep-dive into citronella oil pharmacology: Java vs Ceylon chemotypes, citronellal/geraniol/citronellol composition, TRPA1-mediated insect repellency, mild topical analgesic and antimicrobial actions, dermal sensitization and cumulative-irritation risk, and its role in fengyoujing, anti-mosquito oils, and Southeast Asian liniments."
lang: en
...
- **Java type** — from *Cymbopogon winterianus*. Higher in citronellal (often 30–45%) and total geraniol/citronellol, giving stronger repellent potency and a cleaner odour. This is the type used in most modern repellent and medicated-oil formulations.
- **Ceylon type** — from *Cymbopogon nardus*. Lower citronellal, higher in geraniol, methyl isoeugenol, and borneol-type constituents, with a more "camphoraceous" odour and a weaker repellent profile.
...
- **Citronellal** — a monoterpene aldehyde; the principal spatial repellent and a mild topical analgesic/anti-inflammatory agent.
- **Geraniol** — a monoterpene alcohol; repellent, antimicrobial, and the constituent with the best-characterised long-term safety data.
- **Citronellol** — a monoterpene alcohol; contributes to odour, antimicrobial activity, and a smoother skin feel.
...
- **Fengyoujing (风油精)** — some formulations and many "anti-mosquito" or summer variants add citronella to the menthol/camphor/methyl salicylate/eucalyptus base specifically for the repellent and bite-soothing claim.
- **Southeast Asian and Indonesian oils** — citronella (*serai wangi*) appears in regional liniments and in some *minyak* preparations marketed for outdoor use, where mosquito exposure is the practical driver.
- **Travel and outdoor kits** — products positioned for camping, hiking, and tropical travel lean on citronella to make a single bottle serve as both a rub and a repellent.
...
- **Two oils, not one.** Java-type (high citronellal) is the stronger, cleaner repellent; Ceylon-type is weaker and a recognised weak sensitizer. Labels rarely specify, so treat any citronella product as potentially sensitizing.
- **Repellency is real but short.** Expect roughly 20–120 minutes from an unencapsulated medicated oil; reapply if you need continued protection.
- **The risk is your skin, not your liver.** Systemic toxicity is low; cumulative irritation and allergic contact dermatitis from geraniol/citronellal are the documented problems. Dilute, patch-test, and don't over-apply.
- **Cross-reactivity matters.** Known fragrance or balsam-of-Peru allergy is a reason to avoid citronella-containing oils.
- **Same infant/pregnancy cautions as the base oil.** Citronella adds an allergen layer but does not change the camphor/menthol-driven contraindications that already govern these products.
