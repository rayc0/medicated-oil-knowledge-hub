---
title: "Tian Nan Xing (Arisaema heterophyllum / A. erubescens / A. amurense / Jack-in-the-Pulpit Rhizome / Arisaema Lectin, Schaftoside, β-Sitosterol, Calcium Oxalate Raphides) Pharmacology — The Phlegm-Dissolving, Swelling-Reducing Tuber Anchor of Yu Zhen San, Dit Da Trauma Plasters, Abscess Salves, and Snake-Bite Liniments"
description: "Deep pharmacology of Tian Nan Xing (天南星 / Rhizoma Arisaematis): arisaema lectin, schaftoside, isoschaftoside, β-sitosterol, daucosterol, benzoic acid, trigonelline, and the calcium-oxalate raphide chemistry behind its externally-only raw form. Why Sheng Nan Xing is in Yu Zhen San (玉真散) for tetanus and wound consolidation, why it pairs with Sheng Ban Xia in dit da plasters for stubborn swellings, how ginger-alum processing detoxifies the rhizome for internal use, and what the modern lectin and antitumor research adds to a 1,500-year external-medicine track record."
lang: en
...
1. **Use Sheng Nan Xing (raw form), not prepared.** The prepared and bile-prepared forms are for oral use and contribute much less topically.
2. **Load at 1.5–4 % in oil bases, 3–6 % in alcohol liniments.** Higher loadings demand higher Gan Cao (4–6 %) and ginger juice for irritation management.
3. **Pair with Sheng Ban Xia for stubborn established swellings**; pair with Da Huang, Huang Bai, and Jiang Huang for unripe abscesses; pair with Tian Ma, Bai Zhi, and Fang Feng for wound-channel and convulsion indications.
4. **Avoid mucosal exposure**, label the product clearly as external-use-only, and counsel pregnant users to choose alternative formulas.
5. **Authenticate by tongue-tip burn test** before committing a large batch of raw herb to an oil extraction.
