---
title: "Huang Qin (Scutellaria baicalensis) Pharmacology — Baicalein, Baicalin, Wogonin, and the Lamiaceae Root That Completes the Three Yellows (San Huang) Heat-Clearing Trio"
description: "Complete pharmacology of Huang Qin (Chinese skullcap root, Scutellaria baicalensis): baicalein and baicalin as 12-lipoxygenase inhibitors, wogonin's NF-κB suppression, the golden-yellow flavone chemistry, how it pairs with Huang Lian and Huang Bai in the San Huang trio, and the topical role in red, hot, inflamed skin patterns."
lang: en
...
For full topical safety details across populations, see our [allergy and skin sensitivity guide](../safety/medicated-oil-allergy-and-skin-sensitivity-guide.md) and [pregnancy guide](../safety/pregnancy-and-medicated-oils.md).
...
- [Huang Lian (Coptis chinensis) Pharmacology](./huang-lian-coptis-chinensis-pharmacology.md) — the Heart and middle-burner Yellow
- [Huang Bai (Phellodendron amurense) Pharmacology](./huang-bai-phellodendron-pharmacology.md) — the lower-burner Yellow
- [Ku Shen (Sophora flavescens) Pharmacology](./ku-shen-sophora-flavescens-pharmacology.md) — companion damp-heat-drying root
- [Bai Xian Pi (Dictamnus dasycarpus) Pharmacology](./bai-xian-pi-dictamnus-dasycarpus-pharmacology.md) — Rutaceae root bark for hot, itchy skin
- [She Chuang Zi (Cnidium monnieri) Pharmacology](./she-chuang-zi-cnidium-monnieri-pharmacology.md) — the coumarin-bearing damp-heat partner
