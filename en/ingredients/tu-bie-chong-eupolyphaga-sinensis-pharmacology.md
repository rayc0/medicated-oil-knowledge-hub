---
title: "Tu Bie Chong (Eupolyphaga sinensis) Pharmacology — The Ground Beetle Behind Dit Da Jow, Bone-Knit Pills, and Internal Trauma Liniments"
description: "Complete pharmacology of Tu Bie Chong (土鳖虫 / Eupolyphaga sinensis), the female ground beetle that serves as the iconic zoological ingredient in dit da bone-setting wines, fracture-healing pills, and stasis-breaking trauma formulas. Covers fibrinolytic enzymes, the TF3 osteogenic fraction, and the classical formulas where it lives."
lang: en
...
- *Eupolyphaga sinensis* Walker — the more common northern species
- *Steleophaga plancyi* (Boleny) — the "Chinese-winged" variant, mostly southern
...
> **破血逐瘀，续筋接骨**
> *Break blood, expel stasis; reconnect sinew, mend bone.*

Translated into clinical terms, the herb is indicated for:

- **Traumatic injury** — bruises, contusions, soft-tissue swelling
- **Fractures and tendon ruptures** — internally to accelerate union, externally in dit da jow to break local stasis
- **Blood-stasis amenorrhea** — old, dark, clotted menses with mass-like obstruction
- **Postpartum lochial retention** with abdominal pain
- **Abdominal masses** (癥瘕痞块) — the herb's classical anti-tumoural role, now under modern oncology investigation
- **Lower back and limb stasis pain** with fixed location, worse at night
...
- **Eupolyphaga fibrinolytic enzyme (EFE)** — a serine protease with **dual plasmin-like and trypsin-like activity**. It directly hydrolyses both fibrin and fibrinogen, and additionally activates plasminogen into plasmin, amplifying clot dissolution.
- **TF3 (Tu Bie Chong fraction 3)** — a water-soluble protein fraction shown in 2024 rat studies to significantly accelerate tibial fracture healing by promoting osteoblast proliferation and angiogenesis.
- **Antimicrobial peptides** — defensin-like sequences active against Gram-positive bacteria.
- **Lipid-lowering peptide complex** — implicated in the herb's HDL-raising and total-cholesterol-lowering effects.
...
- TF3 **accelerated callus formation** at week 2
- It **upregulated RUNX2, ALP, and OPN** — master osteogenic transcription factors
- It **promoted CD31+ vessel sprouting** at the fracture site (angiogenesis)
- Histology showed **earlier transition from soft to hard callus**
...
- **Raised HDL/cholesterol ratio**
- **Reduced atherosclerotic plaque area** in aortic sections
- **Modulated gut microbiota** in favour of *Lactobacillus* and *Bifidobacterium* genera
...
- **Da Huang Zhe Chong Wan** (大黄䗪虫丸) — Han dynasty *Jin Gui* formula for "dry blood obstruction" (干血劳); modern use includes chronic hepatic fibrosis and post-surgical adhesions.
- **Bie Jia Jian Wan** (鳖甲煎丸) — for malarial splenomegaly; the modern application is hepatosplenic mass and cirrhosis.
- **Jie Gu Pian / Jie Gu Qi Li Pian** (接骨七厘片) — the canonical bone-knit tablet, taken orally during fracture recovery.
- **Die Da Wan** (跌打丸) — broad-spectrum oral trauma pill paired with topical dit da jow.
...
- The fibrinolytic enzymes (partial — proteins are unstable in pure ethanol but stable enough in 50% aqueous spirit)
- The volatile sulphur compounds (which act as transdermal penetrants)
- The lipid-soluble peptides
...
**Preparation**:
- Live beetles are killed by quick boiling or steaming (preserves enzyme activity better than sun-drying alone) and then dried.
- Some modern producers use **freeze-drying** to retain higher residual fibrinolytic activity for pharmaceutical-grade powders.
- "**Stir-fried**" (炒土鳖虫) is the most common processed form for internal use — the dry-frying mellows the cold/fishy nature and reduces gastric irritation.
...
- **Multi-target action**: Tu Bie Chong combines fibrinolysis with osteogenesis and angiogenesis — a polypharmacological profile no single recombinant protein achieves.
- **Topical bioavailability**: in dit da jow, the alcohol-soluble peptides and volatile sulphur compounds penetrate skin in ways that recombinant enzymes cannot, making it irreplaceable for the local trauma application context.
- **Formula synergy**: in classical pairings (with Da Huang for stasis-heat, with frankincense/myrrh for trauma pain, with Gu Sui Bu and Xu Duan for bone), it occupies a slot no other ingredient fills.
