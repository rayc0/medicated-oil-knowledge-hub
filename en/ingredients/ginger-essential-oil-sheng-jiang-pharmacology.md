---
title: "Ginger Essential Oil (Sheng Jiang) Pharmacology — The Warming Rhizome Behind Postpartum Oils, Thai Compresses, and Ayurvedic Liniments"
description: "A pharmacology deep-dive on ginger essential oil in Asian medicated formulations: zingiberene vs. gingerols, TRPV1 warming, the difference between essential oil and CO2 oleoresin, regional uses (Sheng Jiang vs Gan Jiang, Indonesian jamu, Thai luk pra kob, Indian Mahanarayan), and topical safety."
lang: en
...
- **生姜 *shēng jiāng* (fresh ginger)** — high in volatile monoterpenes (citral, geranial, neral) and gingerols. TCM nature: pungent, slightly warm. Used internally for nausea, externally for surface cold-damp.
- **干姜 *gān jiāng* (dried ginger)** — drying converts gingerols into shogaols. Hotter, deeper, more "interior-warming." TCM nature: pungent, hot.
- **炮姜 *páo jiāng* (charred ginger)** — used in postpartum and bleeding patterns; minimally relevant to topical oils.
- **姜油 *jiāng yóu* (ginger oil)** — steam-distilled essential oil, dominated by sesquiterpenes. This is what shows up on most modern medicated-oil INCI lists.
...
- **Zingiberene**: 25–35% (the signature compound, gives ginger its characteristic terpene-warm aroma)
- **β-Sesquiphellandrene**: 8–12%
- **ar-Curcumene**: 6–11%
- **β-Bisabolene**: 5–8%
- **Camphene**: 4–8%
- **α-Pinene, β-Pinene, β-Phellandrene**: 2–5% each
- **Citral (geranial + neral)**: 1–4% (lemony note)
- **1,8-Cineole, linalool, geraniol**: trace
...
- A perceived warmth at 32–40°C without an actual temperature rise
- Local vasodilation through CGRP and substance P release
- Counter-irritation (the "gate control" pain modulation)
- Slow desensitisation with repeated exposure (similar to capsaicin but milder and reversible faster)
...
- **Cyclooxygenase-2 (COX-2)** — reducing prostaglandin E2
- **5-Lipoxygenase (5-LOX)** — reducing leukotriene B4
- **NF-κB nuclear translocation** — reducing TNF-α, IL-1β, IL-6
...
- **Zingiber officinale root oil** — the steam-distilled essential oil
- **Zingiber officinale root extract** — usually CO2 oleoresin or alcoholic extract; contains gingerols
- **Ginger oil** — generic, usually steam-distilled
- **Sheng Jiang (生姜) / Gan Jiang (干姜)** — TCM names on Chinese-language labels; specifies fresh vs dried
- **Jahe** — Indonesian
- **Khing** — Thai
- **Adrak / Sonth** — Hindi (fresh / dried)
...
- **Ginger + menthol**: the classic "hot-cold" duo of many warming balms; menthol delivers the immediate cooling top-note while ginger provides sustained warmth underneath.
- **Ginger + camphor**: deeply warming; common in postpartum and elderly joint preparations.
- **Ginger + cinnamon + clove**: the "trinity warming" found in jamu, masala oils, and Vietnamese cold-wind formulations.
- **Ginger + eucalyptus**: respiratory-friendly warming; used in chest-rub formulations across the region.
- **Ginger + capsaicin**: unusual but powerful — ginger's TRPV1 partial agonism actually moderates capsaicin's intensity, producing a gentler but longer-lasting warming.
