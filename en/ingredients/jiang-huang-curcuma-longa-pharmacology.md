---
title: "Jiang Huang (Curcuma longa) Pharmacology — The Yellow-Root Behind Dit Da Jow Bruise Pastes, Shoulder Liniments, and the Topical Curcumin Story"
description: "Pharmacology of Jiang Huang (Curcuma longa rhizome): curcuminoids, turmerones, NF-κB inhibition, topical anti-inflammatory action, the classical 'shoulder-and-arm' indication, and how the herb behaves under the skin in dit da jow, bruise pastes, and joint liniments."
lang: en
...
- **Jiang Huang (姜黄)** — *Curcuma longa* rhizome (the main rhizome). Pungent, bitter, warm. Breaks blood, moves qi, expels wind, stops pain. Enters Liver and Spleen.
- **Yu Jin (郁金)** — the *tuberous root* (root, not rhizome) of *Curcuma longa*, *C. wenyujin*, *C. kwangsiensis*, or *C. phaeocaulis*. Pungent, bitter, **cold**. Moves qi, breaks blood, cools heart, releases stagnation. Enters Heart.
- **E Zhu (莪术)** — rhizome of *Curcuma phaeocaulis*, *C. kwangsiensis*, or *C. wenyujin*. Pungent, bitter, warm. Strongly breaks blood and breaks qi. Enters Liver and Spleen.
...
- **Curcumin** (1,7-bis(4-hydroxy-3-methoxyphenyl)-1,6-heptadiene-3,5-dione) — the dominant curcuminoid, ~75% of the curcuminoid fraction.
...
- **NF-κB inhibition** — curcumin blocks IκB kinase, preventing NF-κB nuclear translocation. This is its single most-cited mechanism.
- **COX-2 inhibition** — curcumin downregulates COX-2 transcription (an upstream effect, distinct from how NSAIDs work) and weakly inhibits the enzyme directly.
- **5-LOX inhibition** — reduces leukotriene production.
- **Inflammasome suppression** — both curcumin and ar-turmerone interfere with NLRP3 inflammasome assembly, blunting IL-1β output.
- **Heme oxygenase-1 (HO-1) induction** — curcumin upregulates HO-1, the enzyme that clears heme from hematomas. This is the molecular mechanism behind the classical observation that Jiang Huang "draws out the bruise."
- **Macrophage M1→M2 polarization** — curcumin shifts macrophages from inflammatory to resolution phenotype, accelerating tissue cleanup.
...
- **Direction** — an upper-body bias, useful in shoulder, deltoid, and biceps formulations.
- **Color** — the wine becomes deep amber-yellow, which formulators read as a marker of curcuminoid extraction.
- **Anti-inflammatory backbone** — the curcuminoids and turmerones are alcohol-soluble, so the wine extracts both fractions efficiently.
...
- **Yellow staining.** Curcumin stains skin, fingernails, cotton, and porous countertops. The skin staining fades over 24–48 hours. Cover bedding when applying overnight. Do not use on white shirts you care about.
- **Vehicle matters.** Curcumin is fat-soluble and unstable in alkaline aqueous solution. Oil bases (sesame, jojoba, mineral oil) and ethanol bases (40–70%) preserve activity. Aqueous or alkaline formulations degrade quickly.
- **Heat synergy.** Jiang Huang is a *warm* herb in TCM theory and the topical paste tends to feel mildly warming because of the volatile oil. It works well with a heat pack on top — heat increases blood flow, which clears the bruise faster, and the warmer skin extracts more curcumin from the vehicle.
- **Avoid broken skin.** Curcumin can sting on open wounds and the staining is hard to assess clinically. Topical Jiang Huang is for closed contusions, intact-skin bruising, and joint-area soreness — not lacerations or abrasions.

## Safety considerations

For topical use, Jiang Huang is one of the safer blood-moving herbs in the TCM injury cabinet. Practical cautions:

- **Allergic contact dermatitis** is uncommon but reported, particularly in patients with sensitivity to other Zingiberaceae (ginger family). A patch test is sensible for anyone with reactive skin.
- **Pregnancy** — internal Jiang Huang is contraindicated in pregnancy because of its strong blood-moving action. Topical application over the abdomen and lower back during pregnancy should be avoided. Use over a shoulder or distal limb is generally considered low-risk, but caution is warranted.
- **Anticoagulation.** Curcumin has mild antiplatelet activity in vitro. Systemic absorption from topical application is small, but patients on warfarin, DOACs, or dual-antiplatelet therapy who are using large surface areas of curcumin-rich liniments should be aware.
- **Photosensitivity.** Some curcumin photochemistry is documented under UV exposure; the practical concern is mild but worth knowing — don't apply a heavy curcumin-rich paste and then go sit in direct sun.
