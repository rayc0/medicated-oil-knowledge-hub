---
title: "Tea Tree Oil Pharmacology: Terpinen-4-ol, the ISO 4730 Standard, and Why Oxidised Oil Is the Real Risk"
description: "Tea tree oil (Melaleuca alternifolia) turns up in antiseptic balms, fungal-treatment oils, and acne formulations sold alongside Asian medicated oils. This guide explains its terpinen-4-ol-driven membrane-disrupting mechanism, the ISO 4730 composition standard, what the clinical evidence shows for acne and athlete's foot, why oxidised oil and ascaridole cause most allergic reactions, and the ingestion, infant, and pet safety boundaries."
lang: en
...
- **Terpinen-4-ol** is the principal active component, typically 30–48% (commercial oils usually 35–40%).
- **γ-terpinene** and **α-terpinene** together with terpinen-4-ol make up roughly 70–90% of the whole oil.
- **p-cymene, terpinolene, α-terpineol, and α-pinene** account for another ~15%.
- **1,8-cineole** is deliberately kept low (the standard caps it; high-cineole oils are considered lower quality and more irritating).
...
- **Acne.** A 5% tea tree oil gel has been compared with 5% benzoyl peroxide. Tea tree oil produced a comparable reduction in inflammatory and non-inflammatory lesions, with a slower onset of effect but markedly fewer side effects (less dryness, scaling, redness, and stinging). This is the single best-supported indication.
- **Tinea pedis (athlete's foot).** In a randomised trial of 158 patients, a 50% tea tree oil solution achieved roughly a 64% clinical cure rate versus about 31% for placebo; a 25% solution also outperformed placebo. Lower concentrations relieve symptoms but are less likely to achieve mycological cure.
- **Dandruff and seborrheic conditions.** A 5% tea tree oil shampoo has shown significant improvement in dandruff severity versus placebo.
...
- **Allergic contact dermatitis** is reported in roughly 5% of users, and it is overwhelmingly a problem of degraded oil. An old, repeatedly opened bottle that smells "sharp" or "turpentine-like" instead of fresh is a hazard, not a bargain.
- **Storage rules are not optional.** Keep tea tree oil in a full, tightly sealed, opaque or amber container, away from heat and light, and discard it well before any visible or olfactory change. The same shelf-life and oxidation logic applies to any medicated oil or balm that lists tea tree oil — see the broader storage and expiry guidance for medicated oils.
- **Never apply undiluted oil to broken or inflamed skin.** Even in non-allergic users, neat tea tree oil can cause irritation, stinging, and chemical burns. Typical safe leave-on concentrations are in the low single-digit percent range; the higher concentrations used in athlete's-foot trials (25–50%) were short-contact, supervised, and not for routine daily use.
