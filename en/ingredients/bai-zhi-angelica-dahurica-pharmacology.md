---
title: "Bai Zhi (Angelica dahurica) Pharmacology — The Forehead-and-Sinus Root Behind Headache Rubs, Yang-Ming Liniments, and Classical Skin-Brightening Oils"
description: "A pharmacology-first guide to Bai Zhi: why the root of Angelica dahurica became the dominant herb for frontal headaches and sinus pain, the imperatorin and furanocoumarin chemistry behind its analgesic and anti-inflammatory action, and the photosensitivity problem every topical user needs to understand."
lang: en
...
1. **Dispels wind, releases the exterior, alleviates pain** — used for headache, especially frontal headache, supraorbital pain, and toothache along the upper jaw.
2. **Opens the nasal passages** — the canonical Yang-Ming-channel herb for nasal congestion, sinusitis, and the "stuffy front-of-the-head" pattern of a cold or allergic rhinitis.
3. **Reduces swelling, drains pus, and resolves carbuncles** — used externally on sores, abscesses, and "wind sores" of the skin.
4. **Dries dampness and arrests abnormal vaginal discharge** — an internal-use indication, not directly relevant for medicated oils.
...
1. **Do not apply Bai Zhi-containing products to skin that will be exposed to direct sunlight within the next 12 hours.** Forehead, temple, and cheekbone applications are the highest-risk sites because they are the most likely to receive incidental UV.
2. **Wash the application area before going out into bright daylight** if you applied within the past day. Soap and water remove most of the residual furanocoumarin film.
3. **Avoid layering Bai Zhi products under SPF-free makeup or moisturiser** — the layers do not block UVA.
4. **Be especially cautious with skin-brightening oils**, which are designed to be left on the skin overnight or for extended periods. The cosmetic benefit and the phototoxic risk come from chemically related molecules.
5. **Be aware of the cumulative effect.** Repeated low-dose furanocoumarin exposure followed by UVA can produce hyperpigmentation that emerges only after several applications, even when no individual application caused redness.
...
- [Chuan Xiong Cha Tiao San — Me & Qi formula reference](https://www.meandqi.com/knowledge-base/formulas/chuan-xiong-cha-tiao-san)
