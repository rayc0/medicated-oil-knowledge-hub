---
title: "Wu Jia Pi (Acanthopanax gracilistylus) Pharmacology — The 'Five-Leaf Bark' Behind Joint Liniments, Wu Jia Pi Wine, and Elderly Knee-and-Lumbar Oils"
description: "A deep pharmacology guide to Wu Jia Pi (五加皮, Acanthopanax / Eleutherococcus gracilistylus) — the rheumatic-joint, sinew-strengthening root bark behind classical Wu Jia Pi Wine, dit-da liniments, and elderly knee-and-lumbar medicated oils. Eleutherosides, syringin, sesamin, the toxic 'Northern Wu Jia Pi' lookalike, and how it actually performs when applied topically."
lang: en
...
Yet Wu Jia Pi has a darker historical complication that no honest pharmacology article can skip: for most of the 20th century, a completely **different and toxic plant** — *Periploca sepium* (Xiang Jia Pi / 香加皮 or "Northern Wu Jia Pi") — was traded under the same name. Periploca contains **cardiac glycosides** structurally similar to digoxin. Mistaking the two has caused fatal poisonings. Any serious treatment of this herb has to start there.
...
- **Eleutheroside B (Syringin)** — a phenylpropanoid glycoside; the principal anti-inflammatory and adaptogenic marker. Pharmacopoeia HPLC standards require ≥0.07% syringin in genuine Wu Jia Pi.
- **Eleutheroside E (Acanthoside D, Liriodendrin)** — a furofuran lignan diglucoside; immunomodulatory, anti-osteoporotic in animal models.
- **Sesamin** — a furofuran lignan also found in sesame seed; modulates lipid metabolism, anti-inflammatory.

### 2.2 Triterpenoid Saponins (Chiisanoside-type)
- **Chiisanoside** and its aglycone **chiisanogenin** — bidesmosidic triterpene glycosides showing hepatoprotective, anti-fatigue, and immunoregulatory activity in preclinical work.
- Acanthopanax saponins (Acanthosides B, C, D).

### 2.3 Volatile Oil and Other Constituents
- A modest essential-oil fraction (~0.1–0.3%) containing 4-methylsalicylaldehyde, β-sitosterol, sesquiterpenes — contributes to the slight aromatic/balsamic note that a Wu Jia Pi maceration takes on after weeks in alcohol.
- Polysaccharides (arabinogalactans) — immunomodulatory.
- Trace amounts of vitamin A and B vitamins, free amino acids.
...
- **Suppression of NF-κB** and downstream pro-inflammatory cytokines (TNF-α, IL-1β, IL-6) in synovial fibroblasts.
- **Inhibition of COX-2 and 5-LOX** pathways, reducing prostaglandin and leukotriene mediators.
- **Eleutheroside E in particular** has been reported to inhibit RANKL-induced osteoclastogenesis in bone-marrow macrophages — a mechanistic basis for its traditional reputation in osteoporosis.
...
- Dang Gui 20 g
- Chen Pi 10 g
- Sweet rice wine 1.5–2 L
- Sealed maceration 30–60 days, taken 15–30 mL twice daily.
...
- Lumbar stiffness and weakness
- Hip and shoulder cold-damp arthralgia
- Post-fracture residual stiffness
...
- Wu Jia Pi liniments are unlikely to deliver therapeutic systemic doses.
- Local effects (penetration into superficial dermis and possibly underlying soft tissue with massage and heat) are plausible but modest.
- The traditional pairing with **camphor, borneol, and warming volatile oils** is not just sensory — it materially improves penetration of the polar glycoside fraction.
- Maceration in **rice wine or strong ethanol** (rather than fixed oils) extracts more of the glycosides AND provides a better topical vehicle.
...
- Occasional contact dermatitis from concentrated topical maceration — usually mild, resolves on discontinuation.
- Theoretical mild diuretic effect with prolonged internal use; relevant for patients on furosemide or other diuretics.
- Internal Wu Jia Pi wine can cause mild digestive upset at high doses.
- **Pregnancy:** classically considered "moving" and avoided in pregnancy; modern data are sparse.
...
### 6.3 Interactions
- **Anticoagulants:** mild theoretical concern via syringin and saponins, though clinical data are limited.
- **Antihypertensives:** the diuretic effect could be additive with thiazides.
- **Caffeine and stimulants:** Wu Jia Pi is mildly adaptogenic and may increase wakefulness when combined.
...
- Expect slow-acting, gradual benefit on chronic stiff joints. This is not a "first 5 minutes" sensation product.
- Combine with warmth — Wu Jia Pi-containing oils benefit from massage with a warm towel applied afterwards.
- Best for elderly knee, hip, and lumbar complaints aggravated by cold and damp.
- Not the right tool for fresh sprains, bruises, or acute inflammation — for those, rotate to a hong hua / xue jie / dragon's blood-type acute dit-da liniment instead.

**For people considering homemade Wu Jia Pi wine:**
- Verify botanical source. Buy from a Pharmacopoeia-compliant TCM pharmacy that labels the species, not a roadside stand.
- Macerate in baijiu or 40%+ rice wine for at least 4 weeks; longer (8–12 weeks) yields a fuller extract.
- Standard dose 15–30 mL twice daily — not as an aperitif.
- Avoid in pregnancy, in patients with heart failure or arrhythmia (especially given the Periploca substitution risk), and in active gout flares.

**For formulators:**
- Pair Wu Jia Pi with Du Huo, Sang Ji Sheng, and Niu Xi — the classical anti-rheumatic backbone (Du Huo Ji Sheng Tang structure).
- Add camphor or borneol at 5–10% as a permeation enhancer.
- Use ethanol-based macerations rather than pure oil for better glycoside extraction.
- Specify *Acanthopanax gracilistylus* — never accept ambiguous "Wu Jia Pi" sourcing.
