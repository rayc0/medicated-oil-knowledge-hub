---
title: "Huang Lian (Coptis chinensis / deltoidea / teeta) Pharmacology — Berberine, Coptisine, and the Ranunculaceae Rhizome That Anchors the San Huang Heat-Clearing System"
description: "Deep dive into Huang Lian (Rhizoma Coptidis) pharmacology — the highest natural berberine content in the Chinese materia medica, the species difference between Wei Lian, Ya Lian, and Yun Lian, the isoquinoline alkaloid signature of coptisine and epiberberine, antimicrobial and anti-inflammatory mechanisms, and why this is the rhizome that closes the Huang Bai / Huang Qin / Huang Lian three-yellow heat-clearing triangle."
lang: en
...
## 1. Botany and Source — Three Legal Species, Three Geographies
...
- ***Coptis chinensis* Franch.** — known as **Wei Lian (味連)** or "chicken-claw Coptis (雞爪連)" because several rhizomes cluster from one root crown like the toes of a chicken's foot. Cultivated principally in **Shizhu (Chongqing), Enshi (Hubei), and the Emei (Sichuan) belt**. This accounts for the overwhelming majority of commercial supply and is the industrial source for berberine extraction.
- ***Coptis deltoidea* C.Y. Cheng et Hsiao** — **Ya Lian (雅連)**, "silkworm Coptis (蠶連)," named for its single thicker, curled rhizome resembling a silkworm. Grown only in the **Emei Shan and Hongya (Sichuan)** mountains. Yields are low, prices are high, and traditional physicians describe its action as deeper and more sustained.
- ***Coptis teeta* Wall.** — **Yun Lian (雲連)**, from **northwest Yunnan and southeast Tibet**. This is a wild, CITES Appendix II–listed species and almost never appears in legitimate commercial channels.
...
- **Berberine.** Roughly 60–70 % of total alkaloid; 5.5–10 % of the rhizome by weight in good material. The molecule responsible for the brilliant yellow, and the most studied antimicrobial, anti-inflammatory, antidiabetic, and antitumour compound in the *Coptis* repertoire.
- **Coptisine.** The signature alkaloid of *Coptis* — present at much lower levels in Huang Bai and absent from most other yellow Berberidaceae plants. Documented anti-inflammatory, antiplatelet, and neuroprotective activity. Coptisine is one of the two main HPLC fingerprint peaks used to distinguish authentic Huang Lian from adulterants.
- **Epiberberine.** A stereoisomer of berberine with notably stronger activity against ***Helicobacter pylori*** than berberine itself. The other key HPLC fingerprint peak.
- **Palmatine.** Shared with Huang Bai; documented antifungal activity (especially against *Candida* and dermatophytes), contributing to the herb's dermatological profile.
- **Jatrorrhizine, magnoflorine, columbamine.** Minor protoberberine and aporphine alkaloids contributing to antimicrobial, anti-inflammatory, and mild vasoactive effects.
...
- **Ferulic acid** and **chlorogenic acid** contribute antioxidant capacity and modest anti-inflammatory activity.
- Minor **Coptis lignans A and B** show weak in vitro activity against HSV-1.

### 2c. Polysaccharides and trace volatiles

- *Coptis* polysaccharides have immunomodulatory and mucosal-protective effects, primarily relevant to internal use.
- Trace volatile compounds (β-elemene, caryophyllene-type sesquiterpenes) contribute marginally to oil-macerate extraction.
...
- ***Staphylococcus aureus*** (including several MRSA strains in vitro) — the dominant pathogen in secondarily-infected eczema, folliculitis, acne pustules, and impetigo.
- ***Streptococcus pyogenes*** and ***S. pneumoniae***.
- ***Escherichia coli***, ***Shigella***, ***Salmonella typhi*** — relevant when treating perianal eczema or anorectal lesions.
- ***Pseudomonas aeruginosa*** — moderately sensitive; usually combined with Lian Qiao or Ku Shen for stronger coverage.
- ***Helicobacter pylori*** — epiberberine is particularly active in vitro; this matters less for topical use but speaks to the alkaloid family's ability to cross biological membranes.
...
- **Inhibit NF-κB signalling**, downregulating TNF-α, IL-1β, IL-6, and IL-8.
- **Suppress COX-2 and iNOS expression**, lowering prostaglandin E₂ and nitric oxide production.
- **Inhibit NLRP3 inflammasome activation** — the mechanism that has driven recent interest in *Coptis* for chronic inflammatory skin diseases (atopic dermatitis, psoriasis).
- **Reduce carrageenan-induced paw oedema and xylene-induced ear oedema** in rodent models.
...
- **Fracture colour.** Authentic Wei Lian breaks with a **bright orange-gold to deep golden** interior, with colour penetrating to the central pith. Pale, washed-out, or grey-yellow material indicates aged or low-alkaloid stock.
- **Taste.** Intensely and persistently bitter — bitterness should hit immediately and not give way to any aftertaste sweetness. Thin or sweetly-tinged bitterness suggests adulteration (celandine root and *Mahonia* root present similar visual profiles).
- **HPLC fingerprint.** Reputable suppliers will quantify all four key alkaloids — **berberine HCl, coptisine HCl, epiberberine HCl, and palmatine HCl** — not just a single "total alkaloids" figure.
- **Heavy metals and pesticides.** Rhizome herbs are prone to lead and cadmium accumulation. Pharmaceutical-grade material should come with a recent ICP-MS report.
- **Geographical authentication.** Documented daodi (geographic-authenticity) certificates from **Shizhu (Chongqing) or Lichuan (Hubei)** are the standard provenance markers for premium Wei Lian.
...
- **"Clear heat / drain fire"** → inhibition of NF-κB / COX-2 / iNOS / NLRP3 inflammatory cascades.
- **"Dry damp"** → broad-spectrum antibacterial activity against *S. aureus*, *Streptococcus*, *Candida*, and the dermatophytes that drive the microbial load behind damp-heat presentations.
- **"Remove toxin"** → documented in-vitro neutralisation of bacterial exotoxins (notably *S. aureus* α-haemolysin).
- **San Huang synergy** → Huang Lian governs the upper and middle jiao, [Huang Bai](./huang-bai-phellodendron-pharmacology.md) the lower jiao, and [Huang Qin](./huang-qin-scutellaria-baicalensis-pharmacology.md) the middle and upper-middle — a vertical "zone defence" against damp-heat that recurs in Huang Lian Jie Du Tang, San Huang Lotion, Huang Lian Gao, and most modern haemorrhoid and weeping-eczema ointments.
