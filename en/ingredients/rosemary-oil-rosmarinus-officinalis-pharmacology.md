---
title: "Rosemary Oil Pharmacology — Chemotypes, 1,8-Cineole/Camphor, and Its Role in Medicated Oils"
description: "Deep-dive into rosemary oil (Rosmarinus officinalis) pharmacology: chemotypes (cineole, camphor-borneol, verbenone), the 1,8-cineole–camphor–α-pinene synergy, analgesic and anti-inflammatory mechanisms, transdermal penetration-enhancing effect, safety in epilepsy and pregnancy, and its place in Olbas Oil, white balms, and Western embrocations."
lang: en
...
- **1,8-Cineole chemotype** (Tunisia, Morocco, Spain, France): dominated by 1,8-cineole (eucalyptol), typically 38–55%, with moderate camphor (5–15%) and α-pinene (10–15%). This is the "respiratory / decongestant" rosemary, and the one most often used in inhalant rubs and Olbas-style products.
- **Camphor-borneol chemotype** (Spain, often called "Spanish rosemary"): higher camphor (15–25%) and borneol, lower cineole. This is the "warming muscle rub" rosemary — closer in feel to the camphor-driven Asian balms.
- **Verbenone chemotype** (Corsica, parts of France): high verbenone and lower camphor; prized in cosmetic and skin-regenerative use, and the gentlest of the three.
...
- **Counter-irritation / TRP-channel modulation**: camphor and cineole engage TRPV and TRPA1 channels in cutaneous sensory neurons, producing the warm-cool sensation that gates pain signalling at the dorsal horn — the same "rub it and it hurts less" mechanism behind all camphor/menthol balms.
- **Suppression of the arachidonic-acid cascade and NF-κB signalling**, lowering prostaglandin and pro-inflammatory cytokine output.
- **Smooth-muscle relaxant and spasmolytic activity**, which contributes to its traditional use for tension-type and circulatory complaints.
- **Antioxidant scavenging** of reactive species generated during local inflammation.
...
- **Decongestant inhalant rubs (Olbas-type)**: cineole-chemotype rosemary alongside [eucalyptus](eucalyptus-oil-pharmacology.md), peppermint, cajuput, and clove, where its respiratory-aromatic profile reinforces the "open airways" effect.
- **Western sports and physiotherapy massage oils**: camphor-chemotype rosemary blended into carrier oils for pre-event warming and post-exercise muscle work, exploiting both the rubefacient action and the circulation-stimulating reputation.
- **Multi-herb "white" balms and aromatic chest rubs**, where it adds a green, resinous top note and penetration enhancement.
- **Scalp and hair tonics** — a large, separate body of evidence (notably a trial comparing rosemary oil to minoxidil 2% for androgenetic alopecia) sits outside the medicated-oil scope but explains much of rosemary oil's modern retail visibility.
...
- **Epilepsy and seizure history**: camphor is a known proconvulsant at toxic exposure, and rosemary oil — particularly the camphor chemotype — is widely listed as **contraindicated in people with epilepsy or a seizure disorder**, including inhaled/aromatic use near such individuals. This is the single most important warning.
- **Pregnancy**: rosemary in *medicinal/essential-oil doses* is traditionally avoided in pregnancy (culinary amounts are fine). The combination of camphor exposure and historical emmenagogue/abortifacient folk use is enough that pregnancy and breastfeeding are standard cautions.
- **Infants and young children**: as with all camphor-containing products, avoid application near the face, nose, or chest of infants and children under 2, and use cautiously under 6 — laryngospasm and CNS toxicity from camphor in this age group are well documented. See the [infant safety guide](../safety/infants-and-children.md).
- **Skin**: rosemary oil should be diluted (commonly ≤2–3% in a carrier for body use) — undiluted application can cause irritation and sensitisation. Oxidised oil (old, air-exposed) is more sensitising; the α-pinene and limonene fractions form irritant peroxides over time. Patch-test first.
- **Hypertension**: a frequently repeated traditional caution that rosemary oil may raise blood pressure has weak human evidence, but it remains a common label warning and a reason for caution in uncontrolled hypertension.
- **G6PD deficiency**: rosemary oil is not a classic G6PD trigger the way menthol/naphthalene-type and some essential-oil components are, but products combining it with other oxidant aromatics should still be reviewed against the [G6PD contraindication list](../safety/g6pd-deficiency.md).
- **Drug interactions**: as a penetration enhancer, rosemary oil can increase systemic absorption of co-applied topical drugs (e.g. NSAID gels) — clinically relevant if a product layers rosemary oil over a prescription topical.
...
3. The camphor it contributes is pharmacologically the same camphor you are already tracking in [Tiger Balm-style products](camphor-pharmacology.md) — count it toward total camphor exposure when stacking products.
...
**Sources:** [Chemotypic Characterization and Biological Activity of *Rosmarinus officinalis* (PMC5368539)](https://pmc.ncbi.nlm.nih.gov/articles/PMC5368539/); [*Rosmarinus officinalis* essential oil: phytochemistry, anti-inflammatory activity, and mechanisms of action (ScienceDirect/PubMed 30287195)](https://www.sciencedirect.com/science/article/pii/S0378874118314107); [Anti-inflammatory and antinociceptive effects of *Rosmarinus officinalis* L. essential oil in experimental animal models (PubMed 19053868)](https://pubmed.ncbi.nlm.nih.gov/19053868/); [Transdermal absorption-enhancing effect of the essential oil of *Rosmarinus officinalis* on percutaneous absorption of Na diclofenac from topical gel (Pharmaceutical Biology)](https://www.tandfonline.com/doi/full/10.3109/13880209.2014.984855); [Therapeutic effects of rosemary and its active constituents on nervous system disorders (PMC7491497)](https://pmc.ncbi.nlm.nih.gov/articles/PMC7491497/).
