---
title: "Ma Qian Zi (Strychnos nux-vomica) Pharmacology — The 'Horse-Money Seed' Behind Zheng Gu Shui, Dit-Da Liniments, and Bone-Setting Wines"
description: "A deep pharmacology and safety guide to Ma Qian Zi (马钱子, Strychnos nux-vomica) — the strychnine-bearing seed that hides inside zheng gu shui, classical dit-da jiu, paralysis liniments, and rheumatoid arthritis plasters. Strychnine, brucine, sand-fried processing, transdermal absorption, lethal-dose realities, and how this 'medicine that walks the knife edge' actually performs in topical formulations."
lang: en
...
- **Local analgesia** — brucine blocks voltage-gated sodium channels in peripheral nerves, producing a topical anaesthetic effect comparable in animal models to lidocaine at matched concentration.
- **Anti-inflammatory** — inhibits NF-κB signalling and reduces COX-2 expression in inflamed synovium and rat-paw oedema models.
- **Antitumor activity** — in cell-culture work brucine triggers apoptosis in hepatoma and breast cancer lines; not relevant to topical liniments, but explains some of the pharmaceutical research investment.
...
- Strychnine drops from ~2.1% to ~1.9% (modest)
- Brucine drops from ~1.4% to ~1.3% (modest)
- **Isostrychnine, isobrucine, and the N-oxides rise from near-zero to ~0.3–0.5% combined**
...
- **Oil-fried (油炸马钱子)** — fried in sesame or vegetable oil at controlled temperature; favoured in some southern lineages. Lower temperature, slower conversion, more uniform browning.
- **Vinegar-soaked (醋制马钱子)** — overnight maceration in rice vinegar followed by sand-frying. Vinegar slightly acidifies the alkaloids and is traditionally said to "lead the medicine to the liver and unbind the sinews."
- **Decoction-defatted** — boiling in water and discarding the broth several times; a quality-control step in some plaster manufacturing.
- **Tu fu ling decoction** — co-processing with *Smilax glabra* root, traditionally said to detoxify; modern chemistry suggests modest binding of alkaloids by saponins.
...
- **Zheng Gu Shui (正骨水)** — the iconic Guangxi bone-setting liniment, an alcohol-and-camphor base with Ma Qian Zi as one of its key active herbs alongside Da Huang, Xu Duan, and others.
- **Classical dit-da jiu (跌打酒)** — many Hong Kong, Guangdong, and Lingnan-tradition bone-setting wines include processed Ma Qian Zi at 1–3% of the herb mass.
- **Paralysis-recovery liniments** — formulas for hemiplegia, facial palsy, and post-polio sequelae, almost always containing Ma Qian Zi together with Quan Xie (scorpion), Wu Gong (centipede), and Tian Nan Xing.
- **Rheumatoid-arthritis plasters** — modern TCM hospital plasters for RA and ankylosing spondylitis frequently use a brucine-enriched fraction.
- **Topical tumour plasters** — historical and some contemporary palliative plasters; rare in commercial products.
...
- **Intact skin only.** Never apply to broken skin, open wounds, ulcers, fresh burns, or post-surgical sites — strychnine absorption multiplies dramatically across compromised barrier.
- **Do not occlude.** Never wrap a Ma Qian Zi liniment under plastic film, a tight bandage, or a heating pad. Occlusion massively increases transdermal flux.
- **Limit total area.** Apply to a focal painful area, not to a whole limb or trunk. Total dose absorbed is roughly proportional to area treated.
- **Limit duration.** Most professional protocols specify no more than 2–3 weeks of continuous daily use, with rest periods.
- **Wash hands after application.** Strychnine on hands transfers readily to eyes, mouth, and food.
- **Keep away from children and pets.** A child licking a treated forearm, or a dog grooming a treated shoulder, can ingest a significant dose.

### 5.2 Absolute Contraindications

- **Pregnancy and breastfeeding** — strychnine is a uterine stimulant and crosses the placenta and milk freely.
- **Children under 12** — pharmacokinetics and seizure threshold both unfavorable.
- **Epilepsy or any seizure disorder** — glycine antagonism can precipitate convulsions.
- **Severe hypertension or cardiovascular disease** — strychnine raises blood pressure and reflex tone.
- **Concurrent MAO inhibitors, tricyclic antidepressants, or stimulants** — additive CNS effects.
- **Hepatic or renal failure** — clearance is impaired and accumulation risk rises.
...
- Buy from established brands with batch-release testing.
- Look for explicit "external use only" (外用) marking.
- Check for an expiry date — alkaloid content does shift over years.
- Store sealed, away from heat and light, well out of reach of children.
- Never decant into an unlabeled bottle.
...
- Chinese Pharmacopoeia Commission (2020). *Pharmacopoeia of the People's Republic of China*, vol. 1 — monograph on Ma Qian Zi (Semen Strychni).
...
- Guo R, Wang T, Zhou G et al. (2018). "Botany, Phytochemistry, Pharmacology and Toxicity of *Strychnos nux-vomica* L.: A Review." *Am J Chin Med*.
