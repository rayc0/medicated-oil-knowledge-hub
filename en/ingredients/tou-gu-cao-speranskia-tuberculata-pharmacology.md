---
title: "Tou Gu Cao (Speranskia tuberculata) Pharmacology — The 'Through-Bone Herb' Behind Dit Da Jow, Wind-Damp Liniments, and Deep-Penetration Joint Oils"
description: "A complete pharmacological deep-dive into Tou Gu Cao (透骨草 / Speranskia tuberculata and its regional substitutes), the diterpene-rich 'through-bone' herb that anchors classical dit da jow, wind-damp liniments, and arthritis foot-soaks — covering tigliane-type diterpenes, lignans, anti-inflammatory and counterirritant action, transdermal behavior, formulation pairings, and external-use-only safety."
lang: en
