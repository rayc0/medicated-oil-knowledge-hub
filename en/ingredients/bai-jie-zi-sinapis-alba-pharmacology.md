---
title: "Bai Jie Zi (Sinapis alba / White Mustard Seed) Pharmacology — Sinalbin, Sinigrin, Allyl Isothiocyanate and the TRPA1-Activating Counter-Irritant Behind the San Fu Tie Summer Asthma Plaster Tradition"
description: "A deep pharmacology brief on Bai Jie Zi (白芥子, Sinapis alba / Brassica juncea seeds): the glucosinolate-myrosinase chemistry (sinalbin → 4-hydroxybenzyl isothiocyanate; sinigrin → allyl isothiocyanate), the TRPA1-mediated rubefacient and counter-irritant pharmacology, the central role in the Qing-dynasty Zhang Lu San Fu Tie (三伏貼) summer-treats-winter-disease plaster for cold-type asthma and chronic cough, and the safety discipline — blister depth, application time, processing (chao), pediatric and dermatological contraindications — that every compounder of warming topical pastes must internalise before mixing a Jie Zi paste at the bench."
lang: en
...
1. **Glucosinolates** (sinalbin in *S. alba*; sinigrin in *B. juncea*) — water-soluble sulfur- and nitrogen-rich precursors with a β-thioglucose link. Stable, odourless, non-irritant.
2. **Myrosinase** (β-thioglucoside glucohydrolase, EC 3.2.1.147) — the enzyme that cleaves the glucosinolate. Stored in specialised cells called myrosin cells.
...
1. ITC penetrates the stratum corneum (high lipid solubility, low molecular weight).
2. ITC covalently binds to specific cysteine residues on TRPA1 channels expressed on cutaneous nociceptor terminals, locking them open.
3. The depolarised nociceptors fire, producing the burning/itching sensation and triggering antidromic release of neuropeptides — **substance P** and **calcitonin gene-related peptide (CGRP)** — into the surrounding tissue.
4. Substance P and CGRP cause local **vasodilation, plasma extravasation, mast-cell activation and a neurogenic-inflammation cascade** — the visible erythema and warmth ("rubefacient" action) that the classical literature describes as "scattering cold and unblocking yang qi."
5. With prolonged contact, sustained nociceptor firing causes **gating of central pain modulation** at the dorsal horn — the classical "counter-irritant" effect, in which a controlled superficial pain dampens the perception of a deeper, slower pain (chronic bronchospasm-related chest oppression, asthma "fullness", and so on).
6. At still higher exposure, the inflammatory cascade exceeds physiological vasodilation and causes **dermo-epidermal separation** — the deliberate blister of the classical San Fu Tie technique, which serves as a sustained-release reservoir of inflammatory mediators across the following 12–48 hours.
...
- [Bai Jie Zi (White Mustard Seed) — Sacred Lotus TCM reference](https://www.sacredlotus.com/go/chinese-herbs/substance/bai-jie-zi-white-mustard-seed)
- [White Mustard Seed — TCM Wiki](https://tcmwiki.com/wiki/white-mustard-seed)
...
- [Help for Allergies and Immunity in a Tiny Herbal Patch — NJ Acupuncture Center on San Fu Tie](https://njacucenter.com/help-for-allergies-and-immunity-in-a-tiny-herbal-patch/)
- [白芥子散的质量标准研究 — Chinese Journal of Modern Applied Pharmacy, 2022](https://www.yydbzz.com/article/2022/1004-0781/1004-0781-41-5-698.shtml)
