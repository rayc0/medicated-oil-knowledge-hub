---
title: "Notoginseng (San Qi / Tian Qi) Pharmacology — The Healing Root Behind Yunnan Baiyao"
description: "A pharmacology deep-dive on notoginseng (Panax notoginseng / 三七 San Qi / 田七 Tian Qi) — the headline herb in Yunnan Baiyao and dozens of TCM trauma formulas. Active compounds (PNS saponins, dencichine, notoginsenoside R1, ginsenosides Rg1/Rb1), hemostatic and microcirculatory mechanisms, topical evidence, and why this single root sits at the heart of Chinese trauma medicine."
lang: en
...
- Dencichine acts on **AMPA-type glutamate receptors expressed on platelet membranes**. Most readers know AMPA receptors as central nervous system ion channels — they are also expressed in non-neuronal tissue, including platelets.
- Activation of platelet AMPA receptors triggers **calcium influx** into the platelet cytosol.
- Elevated cytosolic calcium drives **thromboxane A₂ (TXA₂) release** and shifts the local TXA₂:PGI₂ ratio toward aggregation.
- Cytosolic cAMP falls, removing one of the major brakes on platelet aggregation.
- The net effect is faster platelet plug formation and a shorter bleeding time, demonstrated in mouse tail-bleed models in a clean dose-dependent manner.
...
- **Antiplatelet activity** — Ginsenoside Rg1, Rb1, and notoginsenoside Ft1 inhibit platelet aggregation induced by ADP, collagen, and thrombin via P2Y₁₂ receptor antagonism and modulation of intracellular calcium signalling.
- **Vasodilation** — PNS relaxes vascular smooth muscle through nitric-oxide-mediated and calcium-channel-blocking pathways, increasing local blood flow.
- **Microcirculatory improvement** — In animal models of microvascular stasis (the laboratory equivalent of TCM 瘀血), PNS visibly restores capillary flow, reduces plasma extravasation, and shortens the time bruise pigments persist in tissue.
- **Anti-inflammatory action** — Notoginsenoside R1 down-regulates NF-κB signalling, suppressing TNF-α, IL-1β, and IL-6 in damaged tissue. This is the pathway behind the anti-swelling effect that makes San Qi useful for sprains and contusions, not just bleeding wounds.
- **Pro-angiogenic effect** — Ginsenoside Rg1 is a documented stimulator of VEGF-mediated angiogenesis. Translated to wound healing, this means new capillary formation in the granulating wound bed, which is consistent with the classical claim that San Qi accelerates "tissue regeneration."
...
- **Bleeding time and wound haemostasis** — Animal and small-cohort human studies consistently show that topical Yunnan Baiyao reduces bleeding time in superficial wound and post-extraction dental contexts. A 2022 systematic review in *Phytotherapy Research* covering 27 trials found a moderate but consistent effect size for haemostasis in oral surgery and minor cutaneous injury.
- **Bruise resolution** — Human trials in soft-tissue injury show faster ecchymosis fading and reduced swelling at 48–72 hours when notoginseng-containing topicals are used compared with non-active vehicle controls.
- **Wound healing rate** — Granulation tissue formation and epithelialisation are accelerated in animal models, consistent with the Rg1 angiogenic mechanism.
- **Cardiovascular indications** — Outside the topical scope, but worth noting, PNS injectable preparations (Xuesaitong) have ongoing trials for ischaemic stroke, and a 2022 meta-analysis in PMC found that *Panax notoginseng* preparations combined with aspirin showed superior antiplatelet effects compared with aspirin alone in coronary heart disease and ischaemic stroke patients.
...
- *A narrative review of Panax notoginseng: Unique saponins and their pharmacological activities* — PMC11889391
- *Yunnan Baiyao (YNBY): pharmacological mechanisms, therapeutic applications, and clinical evidence* — PMC12284948
- *Decichine enhances hemostasis of activated platelets via AMPA receptors* — PubMed 24630643
- *Platelet P2Y12 receptors are involved in the haemostatic effect of notoginsenoside Ft1* — PMC3874708
- *Protective Effects of Panax Notoginseng Saponins on Cardiovascular Diseases* — PMC4131460
- *Panax notoginseng preparation plus aspirin versus aspirin alone* — PMC9768032
- Chinese Pharmacopoeia, 2020 edition — *Notoginseng Radix et Rhizoma* monograph
- Memorial Sloan Kettering Cancer Center — Yunnan Baiyao patient education materials
