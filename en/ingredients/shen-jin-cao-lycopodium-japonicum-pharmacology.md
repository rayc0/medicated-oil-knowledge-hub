---
title: "Shen Jin Cao (Lycopodium japonicum) Pharmacology — The 'Stretch-Sinew Herb' Behind Joint Liniments, Tendon Oils, and Wind-Damp Dit Da Jow"
description: "A pharmacology-grade deep dive into Shen Jin Cao (伸筋草, Herba Lycopodii) — the Lycopodium alkaloids and serratene triterpenoids behind the tendon-relaxing, wind-damp-dispelling herb that pairs with Tou Gu Cao in classical dit da jow and joint-mobility liniments."
lang: en
...
- **Flavor:** acrid (辛), slightly bitter (苦)
- **Nature:** warm (温)
- **Channels entered:** Liver (肝), Spleen (脾), Kidney (肾)
- **Functions:** dispels wind-damp (祛风除湿), relaxes the sinews and activates the channels (舒筋活络)
- **Classical indications:** wind-damp painful obstruction (风湿痹痛), inhibited flexion and extension of the joints (关节屈伸不利), low back and lower-limb stiffness, traumatic swelling and bruising
...
- **Flavonoids** — contributing antioxidant capacity
- **Phytosterols** — β-sitosterol, stigmasterol, β-daucosterol (mild anti-inflammatory)
- **Phlegmaric acid**, **lycernuic acid A**, **lycojaponicuminol A–F**
- **Physcion** (an anthraquinone)
- **n-octacosanol**, long-chain alcohols
- A small fraction of **volatile oil** giving the dried herb its faint pine/moss aroma
- Trace minerals
...
- Traditional Shaolin and Hung Gar dit da jow recipes
- Modern OTC joint-mobility liniments labeled for "knee/elbow inhibited movement"
- Hospital-style external lotions for post-fracture rehabilitation
- Wind-damp painful obstruction liniments aimed at chronic stiff joints in older patients
...
- **Extraction medium:** high-proof grain alcohol (45–60% ABV) is the traditional choice and pulls both alkaloid and triterpenoid fractions efficiently. Hot water extracts a different, more polar profile and is typically used in compress packs, not bottled liniments.
- **Maceration time:** classical dit da jow recipes call for 30 days minimum, often 100 days, sometimes a year or longer. The slow alkaloid extraction is not a marketing story; lycopodine-type alkaloids genuinely take time to migrate out of cuticle-protected plant material.
- **Dose proportion in formula:** typically a junior/assistant role in the herbal hierarchy — 6–15% of dry-weight formula. It is rarely the dominant herb.
- **Compatibility:** pairs cleanly with Tou Gu Cao, Mu Gua, Du Huo, Qiang Huo, Wei Ling Xian, and Niu Xi. Non-conflicting with camphor/menthol/methyl salicylate top-notes.
...
- **Pregnancy:** classical texts list Shen Jin Cao as contraindicated in pregnancy due to its sinew-relaxing, channel-activating action. Avoid liniments containing it on the abdomen and lower back during pregnancy. Topical use elsewhere on the body should be discussed with a qualified TCM practitioner.
- **Broken skin:** as with any alcohol-based liniment, do not apply over open wounds, abrasions, or recently sutured tissue.
- **Lycopodium alkaloid sensitivity:** rare. People with known sensitivity to clubmoss spores (used historically as pill-coating powder and known to occasionally trigger inhalation reactions) should patch-test first.
- **Drug interactions topically:** not clinically significant at normal doses, but patients on cholinesterase inhibitors or anticholinergic medications should be aware that lycopodium alkaloids are part of the structural family that produced huperzine A. Practical risk from a topical liniment is low; this is mentioned for completeness.
- **Confusion of species:** the trade name "Shen Jin Cao" has historically been applied to several different clubmoss-family species in different regions, and occasionally to *Selaginella* species. The *Pharmacopoeia* standard is *Lycopodium japonicum*. Quality matters — avoid bulk herb of unknown sourcing.
...
- **伸筋草** (Shen Jin Cao) — the standard Chinese name
- **Herba Lycopodii** or **Lycopodii Herba** — the pharmacopeial Latin name
- **Lycopodium japonicum** — the binomial
- **Japanese clubmoss** or **ground pine** — common English names
- **舒筋草** (Shu Jin Cao) — an alternative trade name in some regional formulas, occasionally referring to the same or a substitute species
...
- [Shen Jin Cao (Lycopodium) – 1st Chinese Herbs](https://1stchineseherbs.com/herbs-a-z/s/shen-jin-cao/)
