---
title: "Methyl Salicylate Safety — Benefits, Toxicity, and the Fatal Case That Changed the Labels"
description: "A clinical explanation of methyl salicylate (oil of wintergreen): how it relieves muscle pain, why one teaspoon can kill a child, the 2007 Arielle Newman running case, drug interactions with warfarin, and safe use rules."
lang: en
...
**Physical properties.**
- Boiling point: 220°C
- Density: 1.17 g/mL (heavier than water)
- Soluble in alcohol, oils, and organic solvents; poorly soluble in water
- **Highly permeable through skin**
- Very strong characteristic odour detectable at very low concentrations
...
- **Tiger Balm Red**: ~10% methyl salicylate
- **Tiger Balm White**: ~15% methyl salicylate
- **Bengay (Ultra Strength)**: ~30% methyl salicylate
- **Icy Hot**: ~30% methyl salicylate
- **Deep Heat Rub (UK)**: ~12% methyl salicylate
- **Salonpas patches**: ~6-10% methyl salicylate per patch
- **Chinese medicated plasters (狗皮膏/活血膏藥)**: frequently 15-30%
- **Pure oil of wintergreen**: ~98% methyl salicylate (this is the form that is lethal to children)
...
- **Large body surface area application** — both legs, back, and other areas
- **Multiple products stacked** (cream plus patches)
- **Reapplication between runs without washing off**
- **Heat and sweat** (running increases absorption)
- **Exercise-induced vasodilation** further increasing absorption
- **Possibly also oral aspirin or NSAID use** for muscle soreness
- **Likely extended duration** — days to weeks of heavy use
...
- **Paediatric ingestions.** The US National Poison Data System records hundreds of paediatric methyl salicylate ingestion calls per year. Most involve aromatherapy oil of wintergreen. Fatal cases, while rare, are concentrated in children under 5 who drank from an unlabelled container. Aromatherapy oils marketed as "natural" are often stored casually and not child-proofed.
- **Topical toxicity in elderly.** Case reports of salicylate toxicity in elderly users of high-concentration methyl salicylate rubs, often with impaired renal function (reducing salicylate clearance) and often in combination with low-dose aspirin therapy.
- **Warfarin interaction.** Methyl salicylate, via the salicylic acid metabolite, can potentiate warfarin anticoagulation. Several case reports document dramatic INR increases (into the range of 8-10) in warfarin-stable patients who started using topical methyl salicylate rubs. This is a real and clinically important drug interaction.
...
- **Children under 12 years.** The FDA position is that OTC methyl salicylate rubs should not be used on children under 12. The risk of dose miscalculation, accidental ingestion, and Reye's syndrome-like illness (salicylates are linked to Reye's in children with viral illness) is too high.
- **Infants and toddlers.** No exposure at all. Even small topical applications can produce toxic plasma levels in infants.
- **Warfarin users.** Topical methyl salicylate can cause dramatic INR increases. Coordinate with the prescribing physician before any use.
- **Aspirin-allergic individuals.** Allergic cross-reactivity is documented.
- **Severe renal impairment.** Reduced salicylate clearance increases toxicity risk.
- **Active gastric ulcer or bleeding disorder.** Systemic salicylate absorption can worsen these.
- **Pregnancy, third trimester.** Salicylates in the third trimester are associated with premature ductus arteriosus closure and bleeding risk in mother and newborn. Avoid.
...
- **Never store oil of wintergreen or high-concentration methyl salicylate products within a child's reach.**
- **Keep in original labelled containers.** Do not decant into unlabelled glass bottles.
- **Child-resistant caps.** Required for any product exceeding 5% methyl salicylate content under the US Poison Prevention Packaging Act.
- **Aromatherapy oils are the commonest accident source.** A small brown bottle of "wintergreen essential oil" on a shelf is a paediatric lethal dose waiting to happen. Treat it like a medicine, not a fragrance.
- **If ingestion suspected**, call poison control immediately. In Hong Kong: 2766 1700 (24 hours). In the US: 1-800-222-1222. In the UK: NHS 111. Do not wait for symptoms; the lethal window is hours, not minutes.
...
- [G6PD Deficiency and Medicated Oils](/zh-hans/safety/g6pd-deficiency) (Chinese version)
- [Pregnancy Guide](/zh-hans/safety/pregnancy-guide) (Chinese version)
- [Infants and Children — Contraindications](/zh-hans/safety/infants-and-children) (Chinese version)
