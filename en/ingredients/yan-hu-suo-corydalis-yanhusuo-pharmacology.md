---
title: "Yan Hu Suo (Corydalis yanhusuo) Pharmacology — The Tetrahydropalmatine-Bearing Tuber Behind Pain Liniments, Dit Da Jow, and Modern Topical Plasters"
description: "Pharmacology of Yan Hu Suo (Corydalis yanhusuo): tetrahydropalmatine, dehydrocorydaline, protopine, dopamine D2 receptor antagonism, sodium-channel inhibition, transdermal alkaloid permeation, and how the herb behaves on the skin in dit da jow, neuralgia oils, and modern gel plasters."
lang: en
...
- **Genus confusion.** The name "Corydalis" covers more than 470 species, several of which are used in Chinese folk medicine (*Corydalis bungeana*, *C. ambigua*, *C. decumbens*, *C. saxicola*). Their alkaloid spectra differ — sometimes substantially. The Chinese Pharmacopoeia drug is *only* **C. yanhusuo**, traditionally cultivated in Zhejiang's Pan'an / Dongyang region (the famous *Zhejiang ba wei* "eight famous Zhejiang herbs"). A liniment that calls for "Yan Hu Suo" and gets *C. decumbens* tubers is not the same formula.
- **Vinegar processing matters.** Most classical formulas — internal *and* external — call for **醋延胡索 / Cu Yan Hu Suo** (vinegar-processed). Soaking the tuber in rice vinegar before drying converts the basic alkaloids into vinegar-soluble salts, raising the extractable yield of THP, dehydrocorydaline, and protopine by roughly 30–60% in a hydroalcoholic tincture. Dit da jow recipes that specify *Cu Yan Hu Suo* are not being fussy; they are getting more drug per gram of herb.
- **Adulteration with pumpkin and turmeric scrap.** Because cultivated Yan Hu Suo is expensive, low-end suppliers have been documented padding lots with starch-rich rhizome fragments. A 2024 *Frontiers in Pharmacology* analysis of commercial Corydalis dietary supplements found alkaloid content varying by **two orders of magnitude** between brands — a strong reminder to source from pharmacopoeia-grade suppliers if a topical formula's analgesic action depends on this herb.
...
- A **dopamine D1 / D2 receptor antagonist** (Ki ~124 nM at D1, ~388 nM at D2). This is unusual for an analgesic — most pain pathways do not engage dopamine — and it explains why *l*-THP relieves pain *and* mild anxiety in the same dose.
- A **positive allosteric modulator of GABA-A receptors**, contributing to the sedative quality classically described as "calms the spirit."
- An **α1-adrenergic antagonist**, which contributes to mild peripheral vasodilation and the warming sensation reported with vinegar-processed Yan Hu Suo wines.
...
- **Dehydrocorydaline (DHC)** showed the highest 24-hour cumulative skin permeation of any tested Corydalis alkaloid — roughly **569.7 µg/cm²** through human-equivalent skin in published gel-plaster work — following **zero-order kinetics**, meaning steady-state release. In topical-pharmacology terms, this is a *very* good profile for a sustained-release patch design.
- **Tetrahydropalmatine (THP)** showed moderate permeation (~82.4 µg/cm² over 24 h) following Higuchi diffusion-controlled kinetics. This is the classical "the more you rub, the longer it works" signature, and it can be enhanced 2–4× by the addition of azone, oleic acid, or terpene permeation enhancers (notably borneol — which is why borneol is in nearly every classical jow that contains Yan Hu Suo).
- **Corydaline, tetrahydrocolumbamine, and protopine** all penetrate measurably and distribute into plasma, heart, liver, and kidney tissue when applied transdermally to rats — confirming that a Yan Hu Suo–containing liniment is delivering systemic alkaloid load, not just a surface action.
...
- **Pair with borneol or menthol.** Borneol is one of the best-documented permeation enhancers for protoberberine alkaloids. A formula with Yan Hu Suo *plus* borneol delivers substantially more THP through skin than Yan Hu Suo alone.
- **Vinegar-process or alcohol-process the tuber.** Both raise extractable alkaloid. Wine-processed tubers (酒延胡索) push more alkaloid into a 50–70% ethanol jow; vinegar-processed tubers (醋延胡索) push more into water-and-glycerin–heavy formulas.
- **Use 50–70% ethanol as the main solvent.** Below 30% ethanol, free-base alkaloid extraction is poor. Above 80%, polar co-actives (organic acids, glucosides from companion herbs) drop out. The classical 60% rice-wine baseline is, by accident or by trial-and-error, near-optimal.
- **Expect a yellow color.** Dehydrocorydaline and the protoberberines are intensely yellow. A Yan Hu Suo–containing jow turns deep amber within 2–4 weeks of steeping; this is a useful visual progress indicator.
- **Do not rely on it for blood-stasis breaking.** It is an *analgesic*. If the bruise needs to clear, you still need Hong Hua / Su Mu / Tao Ren / San Qi alongside.

## Where it appears in real bottles

Yan Hu Suo is a quiet workhorse in commercial Chinese topicals. It shows up in:

- **Classical dit da jow recipes** — Ho Family Jow, Tam Sang Jow, Plum Flower's all-purpose injury formulas. Often listed alongside Mo Yao, Ru Xiang, Hong Hua, and Niu Xi.
- **Yunnan-style bone-setting waters** (骨碎补伤药水) — many commercial *die da yao shui* declarations list Yan Hu Suo or Cu Yan Hu Suo in the herb panel.
- **Modern Chinese pain plasters** — a wide range of 镇痛膏 and 关节止痛贴 use Corydalis alkaloid extract as a key analgesic ingredient. The newest gel-plaster generation specifically exploits the DHC permeation profile.
- **Menstrual-pain liniments and warming abdominal oils** — leveraging both the analgesic and the antispasmodic activity of corydaline.
