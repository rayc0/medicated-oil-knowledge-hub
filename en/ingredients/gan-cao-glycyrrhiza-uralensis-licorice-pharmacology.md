---
title: "Gan Cao (Glycyrrhiza uralensis / Licorice Root / Glycyrrhizin, 18β-Glycyrrhetinic Acid, Liquiritin, Isoliquiritigenin, Glabridin) Pharmacology — The Master Harmonizer Anchor of External Trauma Liniments, Eczema Washes, Burn Salves, and Topical Steroid-Sparing Formulas"
description: "Deep pharmacology of Gan Cao (甘草 / Glycyrrhiza uralensis / Radix Glycyrrhizae): glycyrrhizin, 18β-glycyrrhetinic acid, liquiritin, liquiritigenin, isoliquiritigenin, glabridin, licochalcone A, and the triterpenoid-saponin + retrochalcone-flavonoid matrix behind external trauma liniments, eczema and atopic-dermatitis washes, burn ointments, hemorrhoid salves, and the modern compound-glycyrrhizin topical evidence base. Why the 'venerable elder' herb is in roughly 60% of TCM formulas and why its 11β-HSD2 inhibition matters for steroid-sparing dermatology."
lang: en
...
- **生甘草 (Shēng Gān Cǎo, "raw licorice")** — sliced and air-dried only. Higher in glycyrrhizin and the flavonoid liquiritin; the form chosen for external washes, antitoxic decoctions, throat formulas, and the heat-clearing / fire-purging side of the herb's profile. **This is what almost every external medicated-oil formula uses.**
- **炙甘草 (Zhì Gān Cǎo, "honey-fried licorice")** — stir-baked with honey to a dark amber. Some of the glycyrrhizin is hydrolysed to glycyrrhetinic acid during roasting, the flavonoid profile shifts toward the lipophilic flavones, and the herb takes on a warmer, qi-tonifying clinical character. Used in oral tonics (e.g. **炙甘草汤**, Zhi Gan Cao Tang for arrhythmia) but rarely in medicated oils, because the honey caramelisation produces compounds that brown the carrier oil and shorten its shelf life.
...
- **Inhibition of 11β-hydroxysteroid dehydrogenase type 2 (11β-HSD2).** This is the single most important — and most under-explained — mechanism of Gan Cao's topical activity. 11β-HSD2 is the enzyme that converts active cortisol into inactive cortisone inside keratinocytes and immune cells. By inhibiting it, GA causes local cortisol to accumulate at the application site, **potentiating the body's own endogenous anti-inflammatory glucocorticoid signal without administering an exogenous steroid**. This is the molecular basis for the well-documented "steroid-sparing" effect of compound glycyrrhizin ointments in eczema and atopic dermatitis: a clinically relevant anti-inflammatory effect that does not produce skin atrophy, telangiectasia, or steroid rebound.
- **Direct inhibition of phospholipase A2** and downstream arachidonic acid release, blunting prostaglandin and leukotriene generation.
- **Glycyrrhetinic acid binds and antagonises HMGB1**, a danger-associated molecular pattern released by injured cells. This is the mechanism that links Gan Cao to the empirical TCM observation that it "resolves toxin" — it is literally pulling a major sterile-inflammation alarm signal out of circulation in the dermis.
- **Hyaluronidase inhibition**, contributing to the herb's traditional reputation for slowing the spread of swelling and bruising.
...
- **Liquiritin and its aglycone liquiritigenin** — flavanones that inhibit COX-2 expression, scavenge reactive oxygen species, and protect keratinocytes from UV-induced apoptosis.
- **Isoliquiritigenin** — a retrochalcone with strong NF-κB inhibition, tyrosinase inhibition (skin lightening), and an anti-allergic profile that includes stabilisation of mast cells and inhibition of histamine release. This compound carries much of Gan Cao's empirical "anti-itch" activity.
- **Glabridin** (mainly in *G. glabra*) — one of the most potent natural tyrosinase inhibitors known, the molecule behind the entire commercial category of "licorice-extract" skin-lightening serums.
- **Licochalcone A** (concentrated in *G. inflata*) — broad-spectrum anti-inflammatory, antimicrobial against *Cutibacterium acnes* and *Staphylococcus aureus*, and the active in several major European pharmaceutical anti-rosacea and anti-redness OTC lines.
...
**Related Yaoyou Ingredient Pharmacology Articles:** [Camphor Pharmacology](./camphor-pharmacology.md) · [Menthol Pharmacology](./menthol-pharmacology.md) · [Ku Shen (Sophora flavescens) Pharmacology](./ku-shen-sophora-flavescens-pharmacology.md) · [Tu Fu Ling (Smilax glabra) Pharmacology](./tu-fu-ling-smilax-glabra-pharmacology.md) · [Huang Bai (Phellodendron) Pharmacology](./huang-bai-phellodendron-pharmacology.md) · [Da Feng Zi (Chaulmoogra) Pharmacology](./da-feng-zi-hydnocarpus-chaulmoogra-pharmacology.md)
