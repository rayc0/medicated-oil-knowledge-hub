---
title: "Vietnam's Medicated Oil Tradition: Dầu Gió, Cajuput Oil, and the Wind-Illness Concept"
description: "A primary-source guide to Vietnamese medicated oils — the dầu gió category, Eagle Brand history, Huế cajuput oil (dầu tràm), Golden Star Balm, regulatory framework under Vietnam's Ministry of Health, and pediatric safety caveats."
lang: en
category: regions
...
The characteristic green colour comes from plant-derived **chlorophyll**, not from the eucalyptus content — a point often confused in consumer discussion. [^saigoneer]
...
**Regulatory status.** Eagle Brand is registered as a **Chinese Proprietary Medicine (CPM)** under Singapore's Health Sciences Authority (HSA) and is imported into Vietnam under the Ministry of Health's (**Bộ Y Tế**) traditional-medicine registration framework. [^moh-vn]
...
**Chemistry.** Authentic cajuput oil is characterized by a high **1,8-cineole (eucalyptol)** content, typically 40–60%, alongside α-terpineol, α-pinene, and limonene. [^pubchem-cineole] This is pharmacologically similar to — but distinct from — eucalyptus oil. Cajuput oil is listed in the **European Pharmacopoeia** (as *Cajuputi aetheroleum*) and has a separate monograph from eucalyptus.

**Vietnamese infant use — and the safety gap.** Dầu tràm occupies a unique position in Vietnamese parenting: it is routinely applied to newborns for warmth, colic ("đầy hơi"), mosquito bites, and respiratory congestion. Many Vietnamese-language parenting sites describe it as "safe from birth." [^chiaki] [^longchau]

This claim requires careful qualification. International pediatric pharmacology consensus — including the **American Academy of Pediatrics** and **European Medicines Agency (EMA) Committee on Herbal Medicinal Products** — warns that 1,8-cineole and other terpenes can trigger **laryngospasm, bronchospasm, and CNS toxicity in children under 2**, particularly when applied near the nose or on broken skin. [^ema-cineole] The EMA explicitly states that products containing 1,8-cineole should not be applied to the face of children under 30 months.

The reconciliation: diluted dầu tràm applied to the trunk, back, or soles of older infants in a warm bath, with adult supervision, is reasonable and is the actual traditional practice. Concentrated oil applied under the nose of a newborn is not — and several Vietnamese pediatric sources (e.g., Vinmec's clinical advisory) now echo this caution. [^vinmec]
...
**Uses.** Applied to temples for headache, to the chest for congestion, and to insect bites. The pharmacological profile is a standard camphor-menthol counterirritant and carries the same pediatric cautions: **do not use under 2 years**, avoid under the nose in any child, and keep out of reach (camphor ingestion is a well-documented pediatric poisoning cause — AAPCC data consistently rank camphor products among the most common pediatric topical ingestions). [^aap-camphor]
...
- **Dầu Phật Linh** — a camphor-menthol-methyl-salicylate oil associated with Buddhist monastic medicine traditions, produced by the Phật Linh pharmaceutical cooperative.
- **Dầu Trường Sơn** — named after the Trường Sơn mountain range, a domestic cajuput-and-peppermint blend.
- **Dầu Khuynh Diệp Bác Sĩ Tín ("Doctor Tín's Eucalyptus Oil")** — an older Saigon-era brand historically marketed for childhood colic; formulations vary.
- **Dầu gió Kim** — a lower-priced domestic analogue of Eagle Brand.
...
- **Dược điển Việt Nam (Vietnamese Pharmacopoeia, 5th edition, 2018)** contains monographs for the key medicated-oil constituents: menthol (*Mentholum*), camphor (*Camphora*), eucalyptus oil (*Oleum Eucalypti*), cajuput oil (*Oleum Cajuputi*), and methyl salicylate (*Methylis salicylas*). [^dddvn]
- **Circular 01/2018/TT-BYT** sets registration requirements for traditional medicines.
- **Decree 54/2017/NĐ-CP** governs labeling. Products must display active ingredient percentages, warnings, and lot/expiry data in Vietnamese.
...
⚠️ **Coin-rubbing (cạo gió).** The petechiae produced are not therapeutic and can be mistaken for child abuse in overseas clinical settings; cultural-competence literature in U.S. and Australian pediatrics addresses this directly. [^coining]
...
**Is Eagle Brand Vietnamese?**
No. It is a Singapore-origin product (1935) that entered Vietnam in the 1960s and became culturally embedded.

**What is the difference between dầu tràm and eucalyptus oil?**
Both are high in 1,8-cineole, but they come from different trees (Melaleuca cajuputi vs. Eucalyptus globulus). Cajuput has additional α-terpineol and is generally gentler, but pediatric cautions still apply.

**Can I bring medicated oils into the U.S.?**
Yes, generally, for personal use. However, products making drug claims without FDA approval (or selling camphor > 11%) can be detained at the border.

**Are there AI-generated counterfeits?**
Yes. Counterfeit Eagle Brand is widespread in Southeast Asia. Look for holographic stickers, the Singapore HSA registration number, and correct label Vietnamese (imported-legal product has a Vietnamese-language sticker applied by the importer).

---

## 9. Primary Sources

[^eaglebrand]: Eagle Brand official corporate history, Borden Company (Pte) Ltd, Singapore — https://eaglebrand.com.sg/us/ (accessed 2026-04-19).
...
[^moh-vn]: Cục Quản lý Dược (Drug Administration of Vietnam), Bộ Y Tế. Registration framework for traditional medicines. https://dav.gov.vn/
...
[^ema-cineole]: European Medicines Agency, Committee on Herbal Medicinal Products (HMPC). Assessment report on *Eucalyptus globulus* Labill. and related species, essential oil. EMA/HMPC/307781/2012. Restriction on use in children under 30 months.

[^dddvn]: Dược điển Việt Nam V (Vietnamese Pharmacopoeia, 5th edition), 2018. Ministry of Health. Monographs for Mentholum, Camphora, Oleum Eucalypti, Oleum Cajuputi, Methylis salicylas.

[^chiaki]: Chiaki.vn. "Top 14 tinh dầu tràm cho trẻ sơ sinh an toàn, hiệu quả nhất." Consumer advisory article, 2026.
...
[^vinmec]: Vinmec International Hospital clinical advisory. "Cách bôi dầu tràm cho trẻ sơ sinh." https://www.vinmec.com/vie/bai-viet/cach-boi-dau-tram-cho-tre-so-sinh-vi

[^aap-camphor]: American Academy of Pediatrics, Committee on Drugs. "Camphor Revisited: Focus on Toxicity." *Pediatrics* 94(1): 127–128 (1994; reaffirmed). And AAPCC Annual Report data series on topical pediatric ingestions.

[^coining]: Nguyen, H. T., et al. "Cao Gio (Coin Rubbing): Vietnamese Attitudes Toward Health Care and Implications for Western Clinicians." *Journal of Transcultural Nursing* (various editions).

---

## 📩 Commercial Disclosure / Editorial Firewall

This site is independently authored and operated by the CompanyForge AI editorial team.

- **Editorial firewall**: the body above is entirely brand-neutral. We cite primary sources only and accept pull requests — including corrections from competing brands.
- **License**: CC BY 4.0.
- **Commercial disclosure**: the operator's forthcoming brand **Kangleling Active Oil (康乐龄 活络油)** will be launched by Boss Technology Shenzhen.
