---
title: "Zheng Gu Shui (正骨水) — Complete Guide to the 'Bone-Setting Water' Liniment"
description: "Deep dive into Zheng Gu Shui, the famous Guangxi Yulin bone-setting liniment: 26-ingredient Pharmacopoeia formula, Chen Shanwen's history, brush and compress protocols, dieda tradition, safety warnings, and how it differs from Wong To Yick or Tiger Balm."
lang: en
category: brands
date: 2026-05-03
...
- **Polygonum cuspidatum rhizome** (虎杖, Hu Zhang) — Japanese knotweed; anti-inflammatory, contains resveratrol and emodin
- **Cynanchum paniculatum root** (徐长卿, Xu Chang Qing) — paniculate swallowwort; analgesic, antispasmodic
- **Zanthoxylum nitidum root** (两面针, Liang Mian Zhen) — shin-leaf prickly ash; topical analgesic
- **Curcuma zedoaria rhizome** (莪术, E Zhu) — zedoary; promotes blood circulation, breaks stasis
- **Aucklandia lappa root** (木香, Mu Xiang) — moves qi
- **Piper kadsura vine** (海风藤, Hai Feng Teng) — relieves wind-damp obstruction
- **Eupolyphaga sinensis** (土鳖虫, Tu Bie Chong) — ground beetle; classic dieda ingredient for bone injuries
- **Aconitum kusnezoffii tuber** (草乌, Cao Wu) — processed aconite; powerful topical analgesic (toxic if ingested raw)
- **Camphor** (樟脑) — counter-irritant, mild local anesthetic
- **Menthol** (薄荷脑) — cooling sensation, TRPM8 receptor activation
...
- **Inactive ingredients:** Alcohol, Japanese knotweed rhizome, paniculate swallowwort root, shin-leaf prickly ash root, water, zedoary rhizome
...
The two officially active ingredients work through well-characterized mechanisms covered in detail in our [menthol pharmacology](../ingredients/menthol-pharmacology.md) and [camphor pharmacology](../ingredients/camphor-pharmacology.md) guides:

- **Menthol** activates TRPM8 cold-sensing receptors, producing the immediate cooling sensation and a mild gating of pain signals at the spinal level.
- **Camphor** acts on TRPV1 and TRPV3 receptors, producing both warming and anesthetic effects, plus rubefacient (skin-flushing) circulation increase.
- **Ethanol** evaporates rapidly to amplify the cooling sensation and serves as a penetration enhancer for the herbal constituents.
...
- **Sports injuries:** ankle sprains, muscle strains, ligament pulls (post-acute phase)
- **Martial arts conditioning:** Iron Palm, makiwara training, contact sparring bruises
- **Older bruises:** the deep purple-yellow discoloration that lingers after the initial swelling resolves
- **Chronic joint and back pain:** especially the cold, achy, weather-sensitive variety associated with old injuries
- **Post-acupuncture or post-tuina soreness:** practitioners often brush a thin layer over treated areas

It is **not** the right tool for:

- Headaches and cold symptoms — use a [white flower embrocation](white-flower-embrocation-complete-guide.md) or [Kwan Loong oil](kwan-loong-oil-complete-guide.md) instead
- Insect bites and itching — menthol-forward [fengyoujing](fengyoujing-complete-guide.md) is gentler
- Broken skin, burns, or open wounds — never
- Daily aromatic use — the alcohol and herb load is too aggressive for casual application
...
**Children under 2.** Do not use. Camphor toxicity is the well-documented limiting factor — see our [children's safety guide](../safety/medicated-oils-for-children-complete-safety-guide.md). For ages 2–6, supervise carefully and use the brush method only, never the compress.

**Pregnancy.** Avoid. Several of the blood-moving herbs in the traditional formula (*E Zhu*, *Tu Bie Chong*) are classified as contraindicated during pregnancy in TCM, and the camphor/alcohol load adds further reason for caution. See our [pregnancy guide](../safety/pregnancy-guide.md).

**G6PD deficiency.** Avoid topical use over large areas — see [G6PD deficiency guide](../safety/g6pd-deficiency.md).
...
- **Manufacturer name:** Should read **Guangxi Yulin Pharmaceutical Group Co., Ltd. (广西玉林制药集团)**. Other "Zheng Gu Shui" labels exist legally in China but the Yulin version is the original pharmacopoeia formula.
- **U.S. import bottles:** Carry NDC **59321-055** and an FDA Drug Facts panel.
- **Color and clarity:** Authentic product is a clear, dark amber-brown liquid. Cloudy, sediment-heavy, or unusually pale bottles suggest tampering or poor storage.
- **Smell:** Sharp camphor-menthol-ethanol scent with an underlying earthy, slightly bitter herbal note. A pure alcohol or pure menthol smell suggests dilution.
- **Cap and brush:** Original Yulin bottles include an integrated brush applicator under a sealed inner cap. Bottles missing this or shipped with broken seals should be returned.

For more general guidance, see our [counterfeit detection guide](../shopping/counterfeit-detection.md).
...
- A **general-purpose balm** like [Tiger Balm](tiger-balm-complete-guide.md) or [Wong To Yick Wood Lock](wong-to-yick-complete-guide.md) for everyday aches.
- An **aromatic oil** like [white flower embrocation](white-flower-embrocation-complete-guide.md) or [Kwan Loong oil](kwan-loong-oil-complete-guide.md) for headache, cold symptoms, and motion sickness.
