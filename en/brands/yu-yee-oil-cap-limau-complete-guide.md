---
title: "Yu Yee Oil (如意油) — The Cap Limau Baby Soother of Singapore and Malaysia"
description: "A complete guide to Yu Yee Oil, the peppermint-heavy infant colic oil that has been a staple of Straits Chinese homes since the 19th century — formulation, history, application, and safety."
lang: en
category: brands
date: 2026-05-03
...
1. The cool-tingle sensation distracts from cramping discomfort (a classic gate-control mechanism).
2. The mild local warming from clove, cinnamon, and the friction of massage relaxes the abdominal wall musculature.
3. Volatile peppermint vapour is inhaled, which has a mild bronchodilator and anti-nausea effect.
...
1. Place 2–3 drops on the inside of your own wrist first to make sure it is not too cool for the baby.
2. Warm 3–5 drops between your palms until the oil is body-temperature.
3. Stroke the baby's belly clockwise (following the colon) with the flat of your warm hand, never with pressure.
4. Continue for 2–3 minutes, pausing if the baby tenses.
5. Some families also apply a single drop to the soles of the feet and rub gently — a TCM-influenced practice based on the kidney-1 (湧泉) point.
