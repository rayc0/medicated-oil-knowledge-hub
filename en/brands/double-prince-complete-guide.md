---
title: "Double Prince Peppermint Water (法国双飞人) — Complete Guide to Ricqlès Alcool de Menthe and Its Chinese Identity"
description: "A full reference on Double Prince Peppermint Water, the Chinese name for Ricqlès Alcool de Menthe: the 1838 Lyon origin under Heyman de Ricqlès, two centuries of French history, the route to Hong Kong and the naming as 双飞人, the formulation (peppermint essential oil in ~80% ethanol), traditional uses, safety considerations, and the China trademark split that produced Li Jia Peppermint Water as the authentic parallel."
lang: en
category: brands
date: 2026-04-14
...
## The journey to Hong Kong and the name 双飞人
...
## The Hong Kong registration and legal importer
...
## The mainland China trademark split and "Li Jia Peppermint Water"
...
- The **Li Jia / 利佳** name on the box
- The French **Laboratoires Ricqlès / Alcool de Menthe de Ricqlès** text on the label
- Origin labelled as **France (法国)**, not Jiangxi or other Chinese provinces
...
- **Peppermint essential oil (Mentha piperita)** — the active aromatic component, distilled in Provence
- **Ethanol (alcohol)** — approximately **80% v/v** in the classic formulation, serving as both solvent and preservative
- **Purified water** — the remaining volume
...
## Comparison with other medicated oils
...
## Safety profile — the unique cluster of risks
...
### ⚠️ Children under 6 — absolutely contraindicated

The **alcohol content alone** (~80% v/v) is sufficient reason to keep Double Prince well away from children under 6, whether for topical or oral use. Ethanol is efficiently absorbed through the thin skin of infants and young children, and paediatric ethanol poisoning has been documented from topical use of high-alcohol products. In addition, the peppermint oil itself carries the general **menthol infant-apnoea risk** seen with all mentholated products (see our companion article on [menthol pharmacology](../ingredients/menthol-pharmacology.md)) — application near the nose, mouth, or chest of infants can trigger laryngospasm and, in rare cases, respiratory arrest. **Do not use on children under 2 under any circumstances, and avoid oral use in children under 6.**

### ⚠️ Pregnancy and breastfeeding — avoid oral use; topical only in very small amounts

Pregnant and breastfeeding women should **not take Double Prince orally**. The ethanol content is incompatible with pregnancy (no safe threshold for prenatal alcohol exposure is established), and concentrated peppermint oil taken internally has a theoretical uterine-relaxant effect whose significance in late pregnancy is debated. Topical use in small amounts on mosquito bites or the temples is generally considered acceptable, but consult a physician before routine use. See our [pregnancy guide](../safety/pregnancy-guide.md) for the broader framework.

### ⚠️ Alcohol intolerance and disulfiram interactions

Because the product is genuinely **80% v/v ethanol**, oral use is incompatible with:

- Known alcohol intolerance or allergy
- Disulfiram (Antabuse) therapy for alcohol use disorder
- Metronidazole and a few other antibiotics with alcohol interactions
- Advanced liver disease
- Recovery from alcohol use disorder (all alcohol, including "medicinal", is contraindicated)
...
- **Topical — mosquito bites and minor itch:** one drop on the bite, rub in lightly, allow to evaporate. Repeat up to 3-4 times per day.
- **Topical — temples for headache or dizziness:** a single drop on each temple, avoiding the eye area.
- **Aromatic — summer heat or nausea:** a drop on a handkerchief, inhale the vapour.
- **Oral — indigestion or nausea (adults only):** 3-5 drops on a sugar cube, or 5-10 drops in a glass of water or herbal tea, taken no more than 2-3 times per day. Do **not** exceed 2 ml total daily oral intake.
...
- The French text **"Alcool de Menthe de Ricqlès"** prominently on the label
- **Laboratoires Ricqlès** listed as the manufacturer
- **Origin: France / Uzès, Provence**
- In Hong Kong, the Drug Office registration number **HK-03206** on regulated packaging
- In mainland China, the authentic French product is sold as **利佳薄荷水 (Li Jia Peppermint Water)**; bottles marked **双飞人** in mainland retail may be locally-formulated Chinese products unrelated to Laboratoires Ricqlès
- In the Hong Kong supply chain, the distributor of record is **The International Medical Company Limited** (国际医学公司)
...
**Q: Is Double Prince the same as Ricqlès?**
A: Yes — "Double Prince" (双飞人) is the Cantonese name given to Ricqlès Alcool de Menthe after it arrived in Hong Kong in the mid-20th century. The bottle, the formula, and the manufacturer are all the same. The name refers to the two winged figures on the label.

**Q: Can I drink it?**
A: In very small doses (3-10 drops in water, a few times a day maximum), yes — this is the classical traditional indication for indigestion, nausea, and travel sickness, supported by 180 years of European and Chinese household use. Do not exceed small dose ranges, do not use it as a recreational beverage, and do not give it to children or pregnant women.

**Q: How is it different from White Flower Embrocation?**
A: White Flower is an **oil-based** product with menthol, methyl salicylate, camphor, and eucalyptus designed for topical use only. Double Prince is an **alcohol-based** peppermint solution with no camphor, no methyl salicylate, and a traditional oral-use indication. They overlap on dizziness and insect bites but are fundamentally different formulations with different safety profiles.

**Q: Why does the mainland Chinese version taste different?**
A: Because the mainland-registered 双飞人 trademark is held by Chinese domestic manufacturers, not by Laboratoires Ricqlès. The genuine French formulation is sold in mainland China under the name **利佳薄荷水 (Li Jia Peppermint Water)**. Look for "法国" (France) and the Ricqlès name on the packaging.

**Q: Is it halal?**
A: No. The product is approximately 80% ethanol by volume. Muslim consumers who avoid all ethanol-containing products should not use Double Prince.

**Q: Can I use it as mouthwash?**
A: Only heavily diluted — a few drops in a glass of water. Undiluted Double Prince is far too alcoholic and mentholated for direct oral mucosal contact.

## Citations — primary sources

[^1]: **Laboratoires Ricqlès.** "Ricqlès Story" — official brand history. <https://www.laboratoiresricqles.com/en/ricqles-story/> (accessed April 2026). Establishes: 1838 founding in Lyon, Heyman de Ricqlès as founder, 1840 Louis-Philippe medal, 1849 patent, 1853 death, 1857 trademark, 1914 French army issue, 1987 Haribo acquisition, current production in Uzès.

[^2]: **Hong Kong Department of Health Drug Office.** Registered pharmaceutical product entry for "ALCOHOL DE MENTHE DE RICQLES," registration number HK-03206, certificate holder The International Medical Company Limited, original registration 16 January 1979. <https://www.drugoffice.gov.hk/eps/drug/productDetail/en/pharmaceutical_trade/62234> (accessed April 2026).

[^3]: **Wikipedia contributors.** "Ricqlès." Wikipedia, The Free Encyclopedia. <https://en.wikipedia.org/wiki/Ricql%C3%A8s> (accessed April 2026). Secondary source corroborating founder, founding year, and brand history.

[^4]: **European Medicines Agency.** Herbal monograph on *Mentha × piperita L., aetheroleum* (peppermint oil). EMA/HMPC/522410/2013. Establishes pharmacopoeial basis for peppermint-oil-in-alcohol traditional oral indications for functional dyspepsia and minor gastrointestinal complaints in adults.

[^5]: **United States Pharmacopoeia (USP-NF).** Peppermint Oil monograph. Standard reference for identity and purity of the active ingredient used in Alcool de Menthe de Ricqlès.
...
- **License:** CC BY 4.0.
- **Commercial disclosure:** Our operator will soon launch its own medicated oil brand, **Kang Le Ling Huo Luo You (康乐龄 活络油)** by Baisi Technology Shenzhen. This product is a traditional oil-based Chinese medicated oil and is **not related to and does not compete with** Double Prince / Ricqlès, which is a peppermint-alcohol solution.
