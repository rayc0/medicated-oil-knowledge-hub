---
title: "Po Sum On Medicated Oil: Complete Guide (Ingredients, 1907 History, Safe Use)"
description: "A full English guide to Po Sum On Medicated Oil — the Hong Kong household remedy founded in 1907. What's actually in the bottle (menthol 15% plus six Chinese herbs), how it compares to Tiger Balm and Wong To Yick, who should never use it, and how to spot counterfeits."
lang: en
category: brands
date: 2026-04-14
author: Peter Kwok
...
### Active ingredient (US OTC label, DailyMed NDC 54155-052-01)
...
- **Baical Skullcap (*Scutellaria baicalensis*, Huang Qin) root** — classical anti-inflammatory; contains baicalin.
- **Chinese Licorice (*Glycyrrhiza uralensis*, Gan Cao) root** — harmonising herb; mild topical anti-inflammatory.
- **Cinnamon oil (*Cinnamomum cassia*)** — aromatic warming counter-irritant; contributes a small amount of the warming sensation.
- **Dragon's Blood (*Daemonorops draco*, Xue Jie) resin** — traditional "blood-activating" herb; source of the oil's deep amber colour.
- **Peppermint oil (*Mentha × piperita*)** — source of additional menthol and menthone; contributes aroma and cooling.
- **Tea oil (*Camellia oleifera*)** — a mild, stable carrier oil common in south Chinese topical preparations.
...
1. **Menthol and peppermint oil** flood TRPM8 cold-sensing channels on skin sensory nerves, producing the characteristic strong cooling sensation and partially masking underlying pain through gate-control mechanisms.
2. **Cinnamon oil** provides a small, slow TRPA1-driven warming counter-point, which is why the oil feels cool first and then settles into a mild, pleasant warmth after five to ten minutes.
3. **Baicalin, glycyrrhizin, and the Dragon's Blood resin** supply a mild topical anti-inflammatory effect, more gentle but more sustained than the counter-irritant component.
...
- Stiff neck from poor sleeping posture
- Mild joint aches
- Headache relief when rubbed on the temples (cautiously — see below)
- Insect bites and itchy patches
- Travel and motion sickness (a few drops on a cotton ball, inhaled)
- Heat-related fatigue and "stuffy chest" feeling

And less suited to:

- Deep muscular pain that needs a strong warming component (Tiger Balm Red or a salicylate-based liniment is stronger)
- Chronic low-back pain where heat is the main therapeutic lever
- Acute sprains in the first 48 hours (ice is still first-line)

## Safe use: the adult instructions
...
- **Children under 2:** do not use without first consulting a doctor.
- **Children under 12 with arthritis pain:** not recommended — refer to a doctor.
- **Stop and consult a doctor** if the condition worsens, symptoms persist for more than 7 days (or more than 10 days for arthritis), or symptoms clear up and then recur.
- **External use only.** Do not apply to wounds, damaged skin, or areas with existing irritation.
- **Do not bandage tightly.** Avoid contact with the eyes and mucous membranes.
...
## Safety warnings — mandatory reading
...
### ⚠️ Infants and children under 2 — DO NOT USE

The product's own directions exclude children under 2. At an effective total menthol load of roughly 18–22%, Po Sum On is not a nursery product. Menthol and peppermint oil can cause reflex apnoea and severe bronchospasm in infants when applied to the chest, face, or under the nose, and there are documented case reports of respiratory distress and, rarely, death from inhaled or ingested menthol in young children. Topical application to an infant's chest is specifically dangerous because the face is close to the vapour. See our dedicated guide on [infant and under-2 contraindications](../safety/infants-and-children.md).

### ⚠️ Pregnancy — avoid during the first trimester, minimise throughout

There is no strong evidence of teratogenicity from topical menthol at normal doses, but pregnant women should avoid applying any aromatic medicated oil to the abdomen, avoid the first trimester entirely for precautionary reasons, and avoid the inhaled-on-a-cotton-ball motion-sickness use because the vapour dose can be considerable. Cinnamon oil in particular should not be applied to large skin areas during pregnancy. When in doubt, default to a plain cool compress. See our [pregnancy safety guide](../safety/pregnancy-guide.md).

### ⚠️ G6PD deficiency — do not use

Glucose-6-phosphate dehydrogenase (G6PD) deficiency is common across Southern Chinese, Southeast Asian, Mediterranean, and African populations. Menthol is a documented oxidative trigger for haemolytic crises in G6PD-deficient infants, and there are case reports of haemolysis in adults following heavy topical menthol application. A bottle of Po Sum On is essentially a menthol-delivery device, and must not be used on anyone with G6PD deficiency. See our [G6PD contraindication list](../safety/g6pd-deficiency.md).

### Other cautions

- **Asthma and reactive airways disease:** the menthol and peppermint vapour can trigger bronchospasm in susceptible adults; test on a small area before general use and avoid applying near the face.
- **Allergic contact dermatitis:** cinnamon oil, Dragon's Blood, and peppermint oil are all recognised skin sensitisers. First-time users should do a small patch test on the inner forearm and wait 24 hours.
- **Open wounds, eczema, or broken skin:** absorption rises sharply on damaged skin; do not apply.
- **Pets:** menthol and peppermint oil are toxic to cats in particular; keep the bottle out of reach.

## Spotting a counterfeit bottle
...
1. **The box and hologram.** Genuine Po Sum On cartons carry a hologram sticker from the manufacturer. The sticker should shift colour cleanly when rotated under light. Smudgy, flat, or peeling stickers are a warning sign.
2. **The glass bottle.** Genuine bottles are clear or pale-amber glass with a specific embossed marking on the base. Counterfeits often use thicker, darker, or differently-shaped glass.
3. **The dropper.** Genuine bottles use a glass-rod-and-rubber-bulb dropper that dispenses in clean drops. Counterfeit droppers often drip or dribble.
4. **The colour of the oil.** Genuine Po Sum On is a clear, deep gold-amber — the colour comes from the Dragon's Blood resin. A pale yellow, greenish, or murky oil is suspect.
5. **The smell.** Genuine oil smells overwhelmingly of menthol and peppermint with a soft cinnamon-herbal background. A chemical or perfumed smell suggests a fake.
6. **The HK CMedR registration.** Every genuine bottle carries the Hong Kong Chinese Medicine Council proprietary-medicine registration number; you can cross-check it on the CMCHK public database.
7. **The retail channel.** Buy from pharmacies, established TCM shops, the manufacturer's Hong Kong outlets, or authorised international distributors. Marketplace sellers on generic e-commerce platforms carry meaningful counterfeit risk.
...
**Is Po Sum On the same thing as White Flower Oil?**
No. White Flower Oil (白花油) is a separate Hong Kong-origin brand with a different formula. Po Sum On is menthol-forward with a herbal base; White Flower Oil is menthol-plus-methyl-salicylate-plus-camphor-plus-eucalyptus. They are used for overlapping conditions but are pharmacologically different products.

**Can I use it on my temples for a headache?**
Cautiously, and only for adults. A single drop on each temple, massaged gently, is the traditional Cantonese use. Keep it well clear of the eyes. If you have migraine with aura, avoid: strong aromatic stimuli can trigger attacks in some patients. And do not use this approach on children.

**Is it good for motion sickness?**
Yes, for adults and older children. A drop or two on a tissue or cotton ball, inhaled gently, is a common Cantonese household remedy. Do not apply directly under the nose or on the lips, and do not use this approach on children under 12.

**Is Po Sum On vegan?**
The formula is plant-based except for the Dragon's Blood resin (which is a plant resin, not animal-derived, despite the dramatic name). There are no animal-derived ingredients in the standard oil.

**Can diabetics use it?**
Yes, with normal precautions. There is no specific diabetes contraindication. People with diabetic neuropathy should be cautious about applying strongly-cooling or warming products on feet where sensation is reduced — the skin may not feel overuse irritation.
...
2. **Po Sum On Medicine Factory Ltd**, *Company history* (official manufacturer site). https://www.posumon.com.hk/en/
3. **US FDA**, *External Analgesic Drug Products for Over-the-Counter Human Use; Tentative Final Monograph*, 21 CFR Part 348.
4. **Hong Kong Chinese Medicine Council (CMCHK)**, *Proprietary Chinese Medicine Registration* — https://www.cmchk.org.hk (search: 保心安油).
5. **American Academy of Pediatrics**, Committee on Drugs — camphor and menthol exposure in infants.
6. **WHO**, *Glucose-6-phosphate dehydrogenase deficiency: recommendations on sensitising agents*.
7. **European Medicines Agency**, *Assessment report on Mentha × piperita L., aetheroleum* — peppermint oil safety data.

## Related articles

- [Menthol pharmacology — TRPM8, cooling, safe topical use](../ingredients/menthol-pharmacology.md)
- [Camphor pharmacology — mechanism, safe dosing, infant toxicity](../ingredients/camphor-pharmacology.md)
- [Methyl salicylate safety — benefits, toxicity, fatal cases](../ingredients/methyl-salicylate-safety.md)
- [Tiger Balm complete guide](./tiger-balm-complete-guide.md)
- [Wong To Yick Wood Lock Medicated Oil complete guide](./wong-to-yick-complete-guide.md)
- [Can babies use medicated oils? Under-2 contraindications](../safety/infants-and-children.md)
- [Medicated oils in pregnancy: what to avoid by trimester](../safety/pregnancy-guide.md)
- [G6PD deficiency and medicated oils: complete contraindication list](../safety/g6pd-deficiency.md)
