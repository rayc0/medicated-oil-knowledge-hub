---
title: "Minyak Tawon (Bee Brand Medicated Oil) — Makassar's 1912 Lawang-Oil Liniment: Complete Guide to Ingredients, History, Uses, and Safety"
description: "Complete guide to PT Tawon Jaya's Minyak Tawon: the rare lawang-oil (Cinnamomum culilawan) formula, the 1912 'To Boo Loeng' origins in Makassar, white-cap vs red-cap versions, traditional uses for masuk angin and bloating, and the camphor, menthol, and under-2 safety warnings every household should know."
lang: en
category: brands
date: 2026-05-18
...
- **Lawang oil** (*Cinnamomum culilawan* bark/leaf oil) — the signature warming aromatic, eugenol-rich
- **Cajuput oil** (*Melaleuca* — *minyak kayu putih*) — a 1,8-cineole-rich oil giving the characteristic Indonesian "warming and clearing" note
- **Menthol** — for cooling counterirritation via TRPM8 receptor activation
- **Camphor** — for warming counterirritation and the classic medicated aroma
- **Coconut oil** — the carrier base that makes it a pourable rubbing oil rather than a balm
- **Botanical extracts** carried over from the traditional recipe — **garlic** bulb, **ginger** root, **turmeric**, **pepper leaf**, and **citronella-type** aromatics in some presentations
...
- **White cap** — the more potent version, producing intense, penetrating warmth. It is the one most users reach for muscular aches, post-exertion soreness, sprains, and deep massage.
- **Red cap** — a milder-heat version. It is positioned for gentler applications — minor cuts and abrasions, insect bites, and general-purpose rubbing — and is typically offered at a lower price point. The therapeutic intent is broadly similar; the difference is the intensity of the warming effect.
...
- **Masuk angin** — the pan-Southeast-Asian concept of "wind entering the body," covering a cluster of symptoms including chills, bloating, mild nausea, fatigue, and feeling unwell. The oil is rubbed onto the chest, back, abdomen, and sometimes used in *kerokan* (coin-rubbing).
- **Bloating and abdominal discomfort** (*perut kembung*, *masuk angin* of the gut) — massaged onto the abdomen in a clockwise motion.
- **Muscular aches, stiffness, and minor sprains** — the white-cap version applied as a massage liniment, exploiting the counterirritant warming effect.
- **Insect bites and itching** — the red-cap version dabbed onto bites for its cooling-then-warming, mildly anaesthetic effect.
- **Minor cuts and abrasions** — used traditionally as a soothing topical, although this is folk practice rather than a substitute for proper wound care.
- **Headache and dizziness** — small amounts rubbed onto the temples and the back of the neck, as with other wind oils.
...
- [Minyak Tawon — Explore Makassar](https://explore.makassar.go.id/minyaktawon/)
- [Asal Muasal Minyak Tawon dan Manfaatnya bagi Tubuh — Kompas Lifestyle](https://lifestyle.kompas.com/read/2022/09/18/175038820/asal-muasal-minyak-tawon-dan-manfaatnya-bagi-tubuh-jangan-keliru)
- [Minyak Gosok Cap Tawon Asli PT Tawon Jaya Makassar](https://www.minyaktawon.net/minyak-tawon-asli-pt-tawon-jaya-makassar)
- [Cinnamomum culitlawan (PROSEA) — Pl@ntUse](https://plantuse.plantnet.org/en/Cinnamomum_culitlawan_(PROSEA))
- [Cinnamomum culitlawan — Useful Tropical Plants](https://tropical.theferns.info/viewtropical.php?id=Cinnamomum+culitlawan)
- [Minyak Tawon — Manfaat dan Cara Menggunakannya, Halodoc](https://www.halodoc.com/kesehatan/minyak-tawon)
- [Bee Brand Medicated Oil — Golden Needle Online](https://www.goldenneedleonline.com/bee-brand-medicated-oil-3oz.html)
