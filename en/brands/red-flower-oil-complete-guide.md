---
title: "Red Flower Oil (正紅花油) — Complete Guide to the Hong Kong Bruise and Sprain Classic"
description: "A complete reference on Red Flower Oil: the Imada (依馬打) brand history, the 28% methyl salicylate / 30% turpentine pharmacology, the cinnamon-eucalyptus-capsicum supporting cast, the critical 48-hour rule for acute injury, comparisons with Wong To Yick and Zheng Gu Shui, and safety considerations for pregnancy, children, and anticoagulant users."
lang: en
category: brands
date: 2026-05-02
...
- **Koong Yick Medicine (公益堂)** — a Singapore-rooted Chinese medicine factory whose Hung Fa Oil is widely sold across Singapore, Malaysia, and the Hong Kong diaspora. Koong Yick's formulation is similar in profile but tends to lead with a slightly heavier cinnamon note.
- **Ling Nam (嶺南)** — a Hong Kong manufacturer whose "Hung Fa Yeow" bottling is common in Cantonese-speaking communities, particularly in older Hong Kong shop-houses and traditional Chinese medicine clinics.
- **Solstice** — a US-based importer and rebrander that distributes several Red Flower Oil variants (including the safflower-explicit "Zang Hong Hua" line) into North American TCM channels.
...
- Cinnamon oil
- Cinnamon leaf oil
- Capsicum oleoresin (chilli pepper extract)
- Light mineral oil (carrier base)
...
- Simple backaches
- Arthritis (residual aching, not acute flares)
- Strains
- Bruises (after 48 hours)
- Sprains (after 48 hours)

In TCM and clinical practice, Red Flower Oil is most useful for:

- **Stiff, cold-feeling, residual joint pain** — particularly old injuries that "act up" in cold or damp weather
- **Bruise resolution** — accelerating the breakdown of pooled blood under the skin once the acute phase has passed
- **Chronic low back tension** — particularly in office workers, manual labourers, and elderly patients
- **Post-exercise muscle stiffness** — applied the morning after, not immediately after
- **Old sports injuries** — knees, ankles, shoulders that retain stiffness from previous trauma
...
- **Pregnancy.** Methyl salicylate is a Category C topical agent and is explicitly contraindicated for application to the abdomen, lower back, or breasts during pregnancy. The FDA monograph for Imada specifically states it must not be applied to pregnant women's abdomen or waist.
- **Children under 2.** Absolutely contraindicated. Salicylate toxicity risk and Reye-like syndrome concerns make this a hard limit.
- **Children 2 to 12.** Use only under physician guidance, in small amounts, never on broken skin, and never with occlusion.
- **Anticoagulants.** Patients on warfarin, apixaban, rivaroxaban, dabigatran, or therapeutic-dose aspirin should consult their physician before use. Topical methyl salicylate has been documented to elevate INR in warfarin patients via systemic salicylate absorption.
- **G6PD deficiency.** Naphthalene and certain salicylate-containing preparations have been linked to haemolytic events. Use with caution and discontinue if unusual fatigue or jaundice develops.
- **Aspirin allergy.** Cross-reactivity with topical methyl salicylate is well-documented. Patients with salicylate hypersensitivity should not use Red Flower Oil.
- **Broken or inflamed skin.** Increases systemic absorption to potentially toxic levels.
- **Heating pads, hot baths, occlusive bandages.** All increase systemic absorption. Do not combine.
- **Eyes, mouth, mucous membranes.** Highly irritating; flush with copious water if exposure occurs.
