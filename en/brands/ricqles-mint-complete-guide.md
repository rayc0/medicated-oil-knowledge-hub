---
title: "Ricqlès Peppermint Oil (喼汁薄荷油) — Complete Brand Guide 2026"
description: "Ricqlès Extract of Peppermint — the 180-year-old French mint oil sold in Hong Kong pharmacies since the British colonial era. History, composition, traditional uses (motion sickness, fainting, heat stroke), regulatory status, how to use safely, and why Hongkongers still buy the 38 ml glass bottle despite newer alternatives."
lang: en
category: brands
date: 2026-04-15
author: Helen Cheung
...
- A drop on the tongue for queasiness from eating unfamiliar Western food
- A few drops in hot water as a "refreshing tonic" during summer heat
- A topical dab on the temples for headache
- A rescue dose for children suffering from heat stroke at Stanley Beach or Big Wave Bay
...
- **Alcohol (ethanol):** 80% v/v (the legal strength for "extra-strength" digestive extracts in France)
- **Essential oil of peppermint (Mentha × piperita):** 3% w/v, Mitcham origin (the higher menthol variant, as opposed to Chinese or Indian peppermint which has different terpene ratios)
...
- 1,8-cineole (eucalyptol): 6-14%
- Limonene: 1-5%
- Isomenthone, pulegone, and trace terpenes: remainder
...
- **Adults:** 1-3 drops on the tongue or 5-10 drops in hot water, up to 3 times per day. Do not exceed 30 drops per day.
- **Children aged 6-12:** 1 drop in a full glass of water, once or twice per day. Never undiluted on the tongue.
- **Children under 6:** **Do not use orally.** Menthol can cause glottal reflex and bronchospasm in young children. This is the most important safety warning for Ricqlès.
- **Pregnancy:** The 80% alcohol content makes even small doses equivalent to a sip of strong spirit. Avoid unless specifically recommended by a physician. External use is considered safer.
- **Drivers:** A full "nausea rescue" dose of 3 drops in water contains approximately 0.15 ml of pure alcohol — negligible. However, five or more doses within a short period begins to measurably affect breath-alcohol testing in Hong Kong. **Do not drive within 30 minutes of multiple oral doses**.

### External use

- Apply 1-2 drops to temples, wrists, or behind ears. Avoid eye area.
- Do not apply to broken skin, eczema, or sunburn — the alcohol will sting intensely.
- Do not use on infants under 2 years. Menthol absorption through infant skin can trigger apnea events in susceptible babies.

### Storage

- Store upright, tightly capped, **away from sunlight**.
- The 80% alcohol prevents microbial growth indefinitely; Ricqlès has essentially no expiry date in chemical terms, but the menthol slowly oxidizes and the minty intensity fades after about 3-5 years of opened storage.
- Do not refrigerate — peppermint oil separates and the bottle becomes harder to dispense accurately.
...
- Use the correct glass bottle shape but with thinner walls and lighter weight
- Have labels with slightly blurry French text (particularly the small print at the bottom of the label)
- Contain 40-60% alcohol rather than 80%, and use synthetic menthol rather than pure peppermint essential oil
- Have a weaker, more artificial cooling sensation and a distinctive chemical aftertaste
...
- **Morello's Peppermint Essence** (Australian, USD 15/30 ml) — higher essential oil concentration, no alcohol base. Good for cooking use but too intense for oral use.
- **Chinese Mint Oil (薄荷油)** — widely available in Hong Kong herbalists from brands like Xiong Dan 熊膽 and Kong Tai 廣生堂. Lower quality control, often adulterated with synthetic menthol.
- **Po Sum On Medicated Oil** — the other most-common Hong Kong mint-forward medicated oil, but formulated for external use only and with different terpene profile.
- **Taiwanese Mint Gel Roll-ons** — from brands like Eng Aun Tong — modern alternative for external application without the alcohol fire.
