---
title: "Medicated Oils During Pregnancy — What's Safe, What Isn't, and Why the Rules Are Strict"
description: "An evidence-based guide for pregnant women using Chinese and Southeast Asian medicated oils. Which ingredients cross the placenta, which are confirmed teratogens, which are probably fine for topical use, and how to handle the muscle aches, nausea, and cold symptoms of pregnancy without unnecessary risk."
lang: en
category: safety
date: 2026-04-14
author: Peter Kwok
...
## First trimester — the most conservative period
...
## Second and third trimesters — cautious use of specific products
...
### Ingredients to avoid entirely throughout pregnancy
...
### Ingredients that are probably safe in moderation
...
### Ingredients with uncertain or middling evidence
...
## Common pregnancy symptoms and the appropriate response

**Muscle and joint aches** (very common in second and third trimester as the body changes):
- **Preferred**: Rest, warm compresses, pregnancy-safe massage, gentle stretching, prenatal yoga, paracetamol if needed.
- **Avoid**: Tiger Balm / Wong To Yick / Po Sum On / camphor-based rubs; Bengay / Icy Hot / methyl salicylate rubs (especially third trimester); oral NSAIDs.
- **Probably OK in moderation**: Pure menthol roll-ons (without camphor); topical magnesium; heat patches without active chemicals.

**Headaches** (common in first and second trimester):
- **Preferred**: Hydration, rest, cold compress to forehead, paracetamol if needed.
- **Avoid**: Camphor/menthol forehead rubs; peppermint oil applied to temples in the first trimester (just to be conservative).
- **Probably OK in second/third trimester**: Small amount of peppermint oil to temples.

**Cold and sinus congestion**:
- **Preferred**: Saline nasal rinses, humidifier, rest, hydration, paracetamol.
- **Avoid**: Whole-chest rubs with camphor products (Tiger Balm, Vicks VapoRub at daily large doses).
- **Probably OK**: Vicks VapoRub in small amounts on chest once or twice per illness; menthol inhalers; eucalyptus oil in a diffuser.

**Insect bites and itching**:
- **Preferred**: Cold compress, calamine lotion, oral antihistamines that are pregnancy-safe (loratadine, cetirizine).
- **Avoid**: Camphor balms on bites, especially if multiple.
- **Probably OK**: Tiny dab of menthol-only cooling gel for one bite.

**Nausea and morning sickness**:
- **Preferred**: Ginger (tea, capsules, candies), small frequent meals, vitamin B6, obstetrician-prescribed anti-emetics.
- **Avoid**: Wong To Yick oil applied to abdomen (traditional but camphor-containing).
- **Probably OK**: Peppermint tea, peppermint aromatherapy, ginger oil aromatherapy.

**Leg cramps** (common in third trimester):
- **Preferred**: Stretching, hydration, calcium and magnesium intake, warm bath, elevation.
- **Avoid**: Methyl salicylate rubs on calves (especially third trimester).
- **Probably OK**: Warm compress, gentle massage with plain carrier oil, pure menthol rub in small amounts.
...
- **Do not apply any medicated oil to the breast itself** — the baby will consume it during feeding.
- **Wash hands** thoroughly after using any medicated oil before handling the baby.
- **Keep all products out of the baby's immediate environment** — topical application on the mother's back, shoulder, or leg is usually fine; application on the chest near the feeding area is not.
- **Camphor products**: some authorities recommend avoiding even topical use during breastfeeding due to transfer concerns. Pragmatically, small amounts applied to areas far from the breast are probably OK, but the conservative position is to wait until weaning before resuming daily use.
- **Methyl salicylate**: same caution as camphor. Avoid large-area use while breastfeeding.

## The Hong Kong-specific consideration
...
- **Throughout pregnancy**: avoid all camphor, borneol, and high-concentration methyl salicylate products. This rules out Tiger Balm, Wong To Yick, Po Sum On, White Flower Embrocation, Yu Yee Oil, Bengay, Icy Hot, and most traditional Chinese and Southeast Asian balms.
- **In moderation**: menthol, eucalyptus, peppermint, ginger, lavender, and tea tree oils at small topical or aromatherapy doses are probably fine.
- **First trimester**: default to avoiding all topical medicated products where possible.
- **Third trimester**: be especially strict about methyl salicylate due to fetal ductus arteriosus risk.
- **Breastfeeding**: avoid breast-area application; wash hands before handling baby.
- **When in doubt**: ask your obstetrician about the specific product. Do not rely on family elders, traditional practice, or label marketing claims.
