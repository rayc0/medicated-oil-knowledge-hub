---
title: "Medicated Oils and Prescription Drug Interactions: What Patients Must Know"
description: "Evidence-based guide to dangerous and underappreciated interactions between topical medicated oils (Tiger Balm, White Flower, wintergreen oils, camphor rubs) and common prescription drugs — anticoagulants, NSAIDs, antihypertensives, diabetes drugs, and more."
lang: en
category: safety
date: 2026-04-15
author: Peter Kwok
...
| Patient on | Safe topical options | Avoid completely |
|---|---|---|
| Warfarin | Menthol-only creams (Biofreeze, pure peppermint), capsaicin cream, arnica, diclofenac gel (under medical guidance only) | Any product containing methyl salicylate, including Tiger Balm Red/White, Bengay, Icy Hot, Salonpas, White Flower Oil, Kwan Loong, Po Sum On, Deep Heat |
| DOACs (apixaban, rivaroxaban, dabigatran, edoxaban) | Same as above; less evidence but same mechanism applies | Same; case reports exist for rivaroxaban + topical salicylates |
...
## 6. Camphor-containing products and CYP metabolism
...
## 8. Eucalyptus oil and drug metabolism
...
1. **Am I on warfarin or a DOAC?** — If yes, avoid all methyl salicylate products. Use menthol-only, capsaicin, or arnica topicals.
2. **Am I on daily aspirin or an NSAID?** — If yes, limit topical salicylate use to 1–2× daily and watch for bruising or GI symptoms.
3. **Am I on an SSRI or SNRI?** — If yes, same restriction. Triple combinations (SSRI + NSAID + topical salicylate) should be avoided.
4. **Am I diabetic on sulphonylureas?** — Watch for hypoglycaemia.
5. **Am I on antihypertensives and using a rub daily for weeks?** — Monitor BP.
6. **Am I on any transdermal patch (fentanyl, nitroglycerin, rivastigmine, clonidine, HRT estrogen)?** — Do not apply any rub on or near the patch.
7. **Am I on anti-epileptics?** — Avoid heavy camphor exposure.
8. **Am I pregnant, breastfeeding, or applying to a child under 2?** — Consult the separate safety guides; avoid camphor, methyl salicylate, and menthol in these populations.
9. **Am I planning surgery in the next 2 weeks?** — Stop methyl salicylate products at least 5–7 days before surgery (platelet dysfunction).
