---
title: "G6PD Deficiency and Medicated Oils — Which Ingredients Trigger Haemolysis and Why"
description: "A clinical guide to G6PD deficiency (favism) and topical/aromatic exposure to traditional medicated oils. Which ingredients are dangerous, which are probably safe, what the evidence says, and how Hong Kong and Southern Chinese families should navigate daily product choices."
lang: en
category: safety
date: 2026-04-14
...
## What G6PD deficiency actually is
...
- **Mild deficiency (African A- variant)**: haemolysis only with strong triggers, usually self-limited
- **Moderate (Mediterranean variant, the commonest in HK Chinese)**: haemolysis with common drugs, fava beans, and naphthalene; recovery takes 1-2 weeks
- **Severe (Canton variant, rare)**: chronic or very easily triggered haemolysis

Symptoms of acute haemolytic crisis typically appear **24-72 hours after exposure** and include:
- Sudden fatigue and weakness
- Dark (tea/cola-coloured) urine — from haemoglobinuria
- Jaundice — yellow skin and eye whites
- Pale skin
- Rapid heartbeat
- Abdominal or back pain
- In severe cases: confusion, kidney failure, shock
...
## Why Hong Kong takes this especially seriously
...
- **A printed card** listing the diagnosis and substances to avoid
- **A mother-and-child record** updated at every clinic visit
- **Verbal briefing** in Cantonese covering fava beans, mothballs, specific drugs, and "some Chinese herbal products"
...
## The ingredients — which actually matter

### Naphthalene — clearly dangerous
...
### Natural camphor — clinically implicated, probably real risk

**Camphor** is the primary concern for medicated oil users with G6PD deficiency. The evidence is mixed:

- **Case reports** document G6PD haemolytic crises in neonates and infants exposed to strong camphor-containing products (both inhaled and topically). The clearest cases involve whole-body rubs of high-concentration camphor oils in infants — the same scenarios that cause camphor toxicity in non-G6PD infants.
- **Mechanism**: camphor is oxidatively metabolised in the liver (to camphor-10-ol and related metabolites), and in sufficient dose it can generate oxidative stress capable of triggering haemolysis in susceptible red cells.
- **Uncertainty**: the minimum exposure required to trigger haemolysis is not well established. Adult G6PD-deficient individuals using small amounts of topical camphor balm on intact skin probably tolerate it; infants and high-dose topical exposures are clearly risky.
...
### Menthol — probably low risk but watch
...
### Methyl salicylate — theoretical risk, limited evidence
...
### Borneol (冰片) — uncertain, treat as camphor
...
### Clove oil — uncertain, use cautiously
...
### Wintergreen essential oil — probably OK in small amounts, dangerous in large
...
## Specific products and what the G6PD carrier should do
...
1. **Infants and children under 6 years**: Avoid all camphor, borneol, and methyl-salicylate-containing products entirely. Menthol-only products (rare) are probably OK but unnecessary.

2. **Children 6-12 years**: Avoid camphor and borneol. Methyl salicylate products only on very small areas for short periods, if at all.

3. **Adults**: Small amounts of adult-strength products (5-15% camphor/menthol/methyl salicylate) on small areas of intact skin, for short durations, are probably safe. Avoid:
   - Whole-body rubs
   - Under occlusion or heat
   - Repeated daily liberal use
   - Combination with oral aspirin
   - Use during intercurrent illness (infection also causes oxidative stress)

4. **Pregnant G6PD carriers**: The fetus may also be G6PD-deficient. Avoid all camphor and borneol products during pregnancy. Low-concentration menthol topical is probably safe.

5. **Everyone**: Watch for symptoms after use — dark urine, jaundice, unusual fatigue — and stop immediately if any appear. Seek medical attention if symptoms are significant.

## What to do if haemolysis happens

If a G6PD-deficient person uses a medicated oil product and then develops signs of haemolysis within 24-72 hours:

1. **Stop the product immediately.** Wash off any topical residue.
2. **Seek medical assessment** — for mild cases, observation and hydration; for severe cases, hospital admission for monitoring, transfusion if needed.
3. **Do not self-treat with supplements or "detox" products.** Some supplements contain oxidative compounds that can worsen the situation.
4. **Document the product and dose** so the information helps your physician and can be added to your avoid list.
5. **Inform your GP** so it goes on your medical record.
...
## A note on grandparents and well-meaning relatives
...
- [Camphor Pharmacology — Mechanism, Safe Topical Dosing, and Infant Toxicity](/en/ingredients/camphor-pharmacology)
- [Menthol Pharmacology — TRPM8, Cooling Sensation, and Safe Topical Use](/en/ingredients/menthol-pharmacology)
...
- [Infants and Children — Complete Contraindication List](/zh-hans/safety/infants-and-children) (Chinese version)
- [Pregnancy Guide](/zh-hans/safety/pregnancy-guide) (Chinese version)
